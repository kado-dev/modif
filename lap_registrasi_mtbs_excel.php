<?php
	...
	header("Content-Disposition: attachment; filename=Laporan Register Mtbs (".$namapuskesmas." - ".$keydate1." - ".$keydate2.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTRASI PASIEN MTBS</b></h4>
