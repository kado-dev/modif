	...
	<div class="row noprint">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_P2M_penyakit_terbanyak_bulungankab"/>
						...
						<div class="col-sm-2">
							...
							<a href="?page=lap_P2M_penyakit_terbanyak_bulungankab" class="btn btn-sm btn-success"><span class="fa fa-refresh"></span></a>
				...
				<table class="table-judul-laporan-min" width="100%">
					<thead>
						<tr style="border:1px solid #000;">
							...
							<th width="10%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">45-59Th</th>
							<th width="10%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">60-69Th</th>
							<th width="10%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">>70Th</th>
					...
					<tbody style="font-size:10px;">
						...
						while($data = mysqli_fetch_assoc($query)){
							...
							if($_SESSION['kodepuskesmas'] == '-'){
								$usia_4559 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.NoRegistrasi)AS Jumlah 
										FROM `$tbdiagnosapasien` a 
										JOIN `$tbpasienrj` b on a.NoRegistrasi = b.NoRegistrasi
										WHERE YEAR(a.TanggalDiagnosa)='$tahun' and MONTH(a.TanggalDiagnosa)='$bulan'
										and a.KodeDiagnosa = '$kodediagnosa' and b.UmurTahun BETWEEN '45' AND '59'".$polipertamas." ORDER BY Jumlah DESC")); 
								$usia_6069 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.NoRegistrasi)AS Jumlah 
										FROM `$tbdiagnosapasien` a 
										JOIN `$tbpasienrj` b on a.NoRegistrasi = b.NoRegistrasi
										WHERE YEAR(a.TanggalDiagnosa)='$tahun' and MONTH(a.TanggalDiagnosa)='$bulan'
										and a.KodeDiagnosa = '$kodediagnosa' and b.UmurTahun BETWEEN '60' AND '69'".$polipertamas." ORDER BY Jumlah DESC")); 
								$usia_70 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.NoRegistrasi)AS Jumlah 
										FROM `$tbdiagnosapasien` a 
										JOIN `$tbpasienrj` b on a.NoRegistrasi = b.NoRegistrasi
										WHERE YEAR(a.TanggalDiagnosa)='$tahun' and MONTH(a.TanggalDiagnosa)='$bulan'
										and a.KodeDiagnosa = '$kodediagnosa' and b.UmurTahun >= '70'".$polipertamas." ORDER BY Jumlah DESC")); 		
							}else{
								$usia_4559 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.NoRegistrasi)AS Jumlah 
										FROM `$tbdiagnosapasien` a 
										JOIN `$tbpasienrj` b on a.NoRegistrasi = b.NoRegistrasi
							...
							$total = $usia_4559['Jumlah'] + $usia_6069['Jumlah'] + $usia_70['Jumlah'];
						?>
							<tr style="border:1px solid #000;">
								...
								<td style="text-align:right;border:1px solid #000; padding:3px;"><?php echo $usia_4559['Jumlah'];?></td>
								<td style="text-align:right;border:1px solid #000; padding:3px;"><?php echo $usia_6069['Jumlah'];?></td>
								<td style="text-align:right;border:1px solid #000; padding:3px;"><?php echo $usia_70['Jumlah'];?></td>
