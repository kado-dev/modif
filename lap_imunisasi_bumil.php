...
<div class="row noprint">
	<div class="col-lg-12">
		<div class="page-header">
			<h1>Register Imunisasi Bumil</h1>
		</div>
	</div>
</div>
...
<div class="row noprint">
	<div class="col-xs-12 col-sm-12">
		<div class="search-area well well-sm">
			<div class = "row">
				<form role="form">
					<input type="hidden" name="page" value="lap_imunisasi_bumil"/>
					<div class="col-sm-2">
					...
					<div class="col-sm-3">
						...
						<a href="?page=lap_imunisasi_bumil" class="btn btn-sm btn-success"><span class="fa fa-refresh"></span></a>
						<a href="lap_imunisasi_bumil_print.php?opsiform=<?php echo $_GET['opsiform'];?>&keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" target="_blank" class="btn btn-sm btn-primary"><span class="fa fa-print noprint"></span></a>
					</div>
				</form>	
			</div>
		</div>
		...
		<table class="table table-condensed">
			<thead style="font-size:10px;">
				<tr style="border:1px dashed #000;">
					...
					<th rowspan="2" width="7%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Nama Pasien</th>
					<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Tgl.Lahir</th>
					<th rowspan="2" width="12%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Nama Suami</th>
					<th rowspan="2" width="12%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Alamat</th>
					<th colspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Status Pembayaran</th>
					<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Hasil Skrinning</th>
					<th colspan="5" width="5%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Tgl.Imunisasi yang diberikan</th>
					<th colspan="5" width="8%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Tgl.Imunisasi berikutnya</th>
					<th rowspan="2" width="8%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Ket</th>
				</tr>
				<tr style="border:1px dashed #000;">
					<th style="text-align:center; border:1px dashed #000; padding:3px;">Umum</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">BPJS</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD1</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD2</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD3</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD4</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD5</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD1</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD2</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD3</th>
					<th style="text-align:center; border:1px dashed #000; padding:3px;">TD4</th>
		...
		$min = $_GET['h'] - 4;
			...
			if($i <= $max && $i >= $min){
				if($_GET['h'] == $i){
					...
					echo "<li><a href='?page=lap_imunisasi_bumil&opsiform=$opsiform&keydate1=$keydate1&keydate2=$keydate2&bulan=$bulan&tahun=$tahun&h=$i'>$i</a></li>";
				}
			}
		}
	?>	
