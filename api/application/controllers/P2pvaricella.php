...
/**
 * Controller untuk API P2P Varicella
 * Endpoint: /index.php/p2pvaricella/index/{kode_puskesmas}/{tahun}/{bulan}
 * Method: GET
 * 
 * Mengembalikan data kasus Varicella (B01) per golongan umur dan jenis kelamin
 */
class P2pvaricella extends REST_Controller {
	...
	public function index_get(){
		try {
			...
			// Query untuk setiap golongan umur (sama seperti DBD)
			...
			log_message('error', 'P2P Varicella API Error: ' . $e->getMessage());
			$response_data = [
				'Pesan' => [
