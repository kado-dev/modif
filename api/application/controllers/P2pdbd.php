...
/**
 * Controller untuk API P2P DBD
 * Endpoint: /index.php/p2pdbd/index/{kode_puskesmas}/{tahun}/{bulan}
 * Method: GET
 * 
 * Mengembalikan data kasus DBD (A90, A91) per golongan umur dan jenis kelamin
 */
class P2pdbd extends REST_Controller {
	 ...
	 * - tahun (required)
	 * - bulan (optional, jika tidak ada atau "Semua" akan mengambil semua bulan)
	 * 
	 * Query Parameter:
	 * - table_suffix (optional) - suffix nama tabel
	 */
	public function index_get(){
		try {
			...
			// Cek apakah tabel ada menggunakan information_schema
			...
			log_message('error', 'P2P DBD API Error: ' . $e->getMessage());
			$response_data = [
				'Pesan' => [
