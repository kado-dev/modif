<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Distribusi_Unit_Per-Item_Barang (".$kota." ".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN DISTRIBUSI UNIT (PER-ITEM BARANG)</b></h4>
...
<?php
	...
	$str = "SELECT b.TanggalPengeluaran, b.NoFaktur, b.Penerima, a.KodeBarang, c.NamaBarang, SUM(a.Jumlah) AS Jumlah, a.Harga
			...
			GROUP BY Penerima";
	$str2 = $str." ORDER BY b.`Penerima` ASC";		
