...
<div class="formbg">
	...
	<img src="image/tarakan.png" style="width:80px;position: relative;left:0px;top:0px">
		<center style="margin-top: -80px;">
			...
			<p style="font-size:16px; font-weight:bold; margin-top: -10px;"><?php echo "PEMERINTAH ".$kota;?><p>
			<p style="font-size:16px; font-weight:bold; margin-top: -10px;"><?php echo "DINAS KESEHATAN"?><p>
			<p style="font-size:22px; font-weight:bold; margin-top: -10px;"><?php echo "PUSKESMAS ".$namapuskesmas;?><p>
			<p style="font-size:12px; font-weight:bold; margin-top: -10px;"><?php echo $alamat;?><p>
				<hr style="border-top:double">
			<p style="font-size:14px; font-weight:bold; margin-top: -10px;"><u>SURAT KETERANGAN DOKTER</u><p>
			...
			Yang bertanda tangan di bawah ini, <?php echo $dtpoliskd['NamaDokter'];?> , Dokter Pada Pusat Kesehatan Masyarakat
			<? echo $namapuskesmas;?>, dalam menjalankan tugas mengingat Sumpah Jabatan menerangkan bahwa :
			<p>
			...
			<p style="text-align: right;margin-top: 20px"><a href="javascript:print()" class="btn btn-lg btn-success noprint">Print</a></p>
		</center>
