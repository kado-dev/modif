...
/**
 * Controller untuk API P2P Mump
 * Endpoint: /index.php/p2pmump/index/{kode_puskesmas}/{tahun}/{bulan}
 * Method: GET
 * 
 * Mengembalikan data kasus Mump (B26.9) per golongan umur dan jenis kelamin
 */
class P2pmump extends REST_Controller {
	...
	public function index_get(){
		try {
			...
			log_message('error', 'P2P Mump API Error: ' . $e->getMessage());
			$response_data = [
				'Pesan' => [
