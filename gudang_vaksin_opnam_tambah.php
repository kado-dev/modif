<div class="tableborderdiv">
	<div class="row">
		<div class="col-xs-12">
			<a href="index.php?page=gudang_vaksin_opnam" class="backform"><i class="fa fa-chevron-circle-left fa fa-2x"></i><span></span></a>
			...
			<div class="formbg" style="padding: 50px 50px 50px 50px;">
				<div class = "row">
					...
					?>
					<form action="?page=gudang_vaksin_opnam_tambah_proses" method="post">
