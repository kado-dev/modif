...
<div class="row noprint">
	<div class="table-responsive noprint">
		<table class="table-judul-laporan-min" width="100%">
			...
			<tbody>
				<?php
				$waktu = "YEAR(a.TanggalRegistrasi) = '$tahun'";
				...
				if($bulan == "Semua"){
					$strdiagnosabln = "SELECT * FROM(
						SELECT * FROM `tbdiagnosapasien_01` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_02` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_03` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_04` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_05` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_06` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_07` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_08` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_09` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_10` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
						SELECT * FROM `tbdiagnosapasien_11` WHERE YEAR(`TanggalDiagnosa`)='$tahun' AND SUBSTRING(NoRegistrasi,1,11) = '$kodepuskesmas'
						UNION
				...
				while($data = mysqli_fetch_assoc($query)){
					...
					$umur17hrL= mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan = '0' AND a.UmurHari Between '1' AND '7' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur17hrP = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan = '0' AND a.UmurHari Between '1' AND '7' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur1830hrL = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan = '0' AND a.UmurHari Between '8' AND '30' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur1830hrP = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan = '0' AND a.UmurHari Between '8' AND '30' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur12blnL = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan Between '2' AND '12' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur12blnP = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun = '0' AND a.UmurBulan Between '2' AND '12' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur14L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '1' AND '4' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur14P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '1' AND '4' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur59L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '5' AND '9' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur59P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '5' AND '9' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur1014L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '10' AND '14' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur1014P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '10' AND '14' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					...
					$umur2044L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '20' AND '44' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur2044P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '20' AND '44' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur4554L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '45' AND '54' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur4554P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '45' AND '54' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur5559L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '55' AND '59' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur5559P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '55' AND '59' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					...
					$umur6069P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '60' AND '69' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
					$umur70100L = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '70' AND '100' AND a.JenisKelamin = 'L' AND b.Kasus = 'Baru'"));
					$umur70100P = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '70' AND '100' AND a.JenisKelamin = 'P' AND b.Kasus = 'Baru'"));
										
					// kasus lama
					$lama_l = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '0' AND '100' AND a.JenisKelamin = 'L' AND b.Kasus = 'Lama'"));
					$lama_p = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(a.NoRegistrasi)AS Jml FROM `$tbpasienrj` a join `tbdiagnosapasien_bulan` b on a.NoRegistrasi = b.NoRegistrasi WHERE $waktu AND SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND b.KodeDiagnosa like '$kodedgs' AND a.UmurTahun Between '0' AND '100' AND a.JenisKelamin = 'P' AND b.Kasus = 'Lama'"));
					$t_lama_l = $lama_l['Jml'];
					$t_lama_p = $lama_p['Jml'];
