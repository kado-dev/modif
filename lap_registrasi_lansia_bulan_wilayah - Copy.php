				...
				<table class="table-judul-laporan" width="100%">
					...
					<tbody>
						...
						while($data_kel = mysqli_fetch_assoc($query)){
							...
							$sasaran70_L_B = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*)AS Jml FROM `tbpasienrj_bulan` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND YEAR(a.TanggalRegistrasi)='$tahun' AND a.JenisKelamin='L' AND a.StatusKunjungan='BARU' AND a.AsalPasien='10' AND a.UmurTahun BETWEEN '70' AND '100' AND a.PoliPertama='POLI LANSIA' AND b.Kelurahan like '%$kelurahan%';"));
							$sasaran70_L_L = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*)AS Jml FROM `tbpasienrj_bulan` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND YEAR(a.TanggalRegistrasi)='$tahun' AND a.JenisKelamin='L' AND a.StatusKunjungan='LAMA' AND a.AsalPasien='10' AND a.UmurTahun BETWEEN '70' AND '100' AND a.PoliPertama='POLI LANSIA' AND b.Kelurahan like '%$kelurahan%';"));
							...
							$sasaran70_P_L = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*)AS Jml FROM `tbpasienrj_bulan` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.NoRegistrasi,1,11)='$kodepuskesmas' AND YEAR(a.TanggalRegistrasi)='$tahun' AND a.JenisKelamin='P' AND a.StatusKunjungan='LAMA' AND a.AsalPasien='10' AND a.UmurTahun BETWEEN '70' AND '100' AND a.PoliPertama='POLI LANSIA' AND b.Kelurahan like '%$kelurahan%';"));
		...
		<div class="col-sm-12">
			<div class="alert alert-block alert-success fade in">
				...
				<table style="font-size:14px; width:100%">
					<?php
						$pralansia = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM `tbpasienrj_bulan` WHERE SUBSTRING(NoRegistrasi,1,11)='$kodepuskesmas' AND YEAR(TanggalRegistrasi)='$tahun' AND `UmurTahun` BETWEEN '45' AND '59'"));
						$lansia = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM `tbpasienrj_bulan` WHERE SUBSTRING(NoRegistrasi,1,11)='$kodepuskesmas' AND YEAR(TanggalRegistrasi)='$tahun' AND `UmurTahun` BETWEEN '60' AND '100'"));
					?>
