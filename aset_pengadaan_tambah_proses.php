...
$tahun=date('Y');
$sql_cek="SELECT max(NoFaktur)as maxno FROM `tbasetpengadaan` WHERE SUBSTRING(NoFaktur,13,4)='$tahun' AND SUBSTRING(NoFaktur,1,11)='$kodepuskesmas'";
...
$str = "INSERT INTO `tbasetpengadaan`(`TanggalPengadaan`,`JamPengadaan`,`NoFaktur`,`SumberAnggaran`,`TahunAnggaran`,`KodeSupplier`,`Keterangan`,`NamaPegawaiSimpan`)
...
if($query){	
	...
	echo "document.location.href='index.php?page=aset_pengadaan';";
	echo "</script>";
}else{
	echo "<script>";
	echo "alert('Data gagal disimpan...');";
	echo "document.location.href='index.php?page=aset_pengadaan_tambah';";
	echo "</script>";
} 
?>