...
<?php
if($_GET['sts'] == 'bandung'){
	$namalogo = 'bandungkota.png';
	$namadinas = 'Kota Bandung';
}else{
	$namalogo = 'bandungkab.png';
	$namadinas = 'Kabupaten Bandung';
}
?>
 <body>
    <div class="container">
       <div class="row">	
			<div class="col-sm-6" style="padding-top:30px;color:#fff;">
				<img src="image/<?php echo $namalogo;?>" class="logokiri"/>
				<div class="textlogo">Dinas Kesehatan<br/>
				<?php echo $namadinas;?></div>
			</div>
			<div class="col-sm-6 hidden-xs" style="padding-top:30px;color:#fff;">	
				<img src="image/puskesmasonlinewhite.png" class="logokanan"/>
			</div>
            <div class="col-md-4 col-md-offset-4 garis">
				<div class="textlogin">
					<h2>pkmonline</h2>
					<p>Aplikasi Manajemen Puskesmas Versi 1.3</p>
				</div>	
