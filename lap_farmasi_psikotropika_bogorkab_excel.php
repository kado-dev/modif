<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Narkotik_Psikotropik (".$namapuskesmas." ".$tahun.").xls");	
?>
<style>
.tr, th{
	text-align:center;
...
<div class="printheader">
	...
	<span class="font16" style="margin:15px 5px 5px 5px;"><b>LAPORAN NARKOTIK PSIKOTROPIK</b></span><br>
