	...
	<div class="row search-page noprint" id="search-page-1">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_farmasi_psikotropika_bogorkab"/>
						...
						<div class="col-sm-3">
							...
							<a href="?page=lap_farmasi_psikotropika_bogorkab" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<!--<a href="javascript:print()" class="btn btn-success btn-white">Print</a>-->
							<a href="lap_farmasi_psikotropika_bogorkab_excel.php?bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahun=<?php echo $_GET['tahun'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</form>
				</div>
			</div>
