    ...
    <div class="row">
        <div class="col-md-12">
            <form action="skrining_hipoteroid.php" method="post">  
                ...
                <div class="card">
                    <div class="card-body">
                        <p style="font-size: 20px; font-weight: bold;" class="judul">Skrining Jantung Bawaan
                            <a href="index.php?page=skrining&idrj=<?php echo $idpasienrj;?>" class="btn btn-info btn-round pull-right">Kembali</a>
                        </p>
