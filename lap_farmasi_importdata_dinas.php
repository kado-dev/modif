...
<div class="tableborderdiv">
	<div class="row">
		<div class="col-xs-12">
			...
			<h3 class="judul"><b>REKAP DATA <?php echo $namapuskesmas;?></b></h3>
			<!--<div class="formbg" style="padding:20px 20px 10px 20px;">
				<div class = "row">
					<input type="hidden" name="page" value="lap_farmasi_importdata_dinas"/>
					<div class="col-sm-12">
						<form class="form-inline" method="post" enctype="multipart/form-data" action="lap_farmasi_importdata_dinas_import.php" id="formsx">
							<table width="100%" style="margin-bottom: 10px;">	
								<tr>
									...
									<td width="20%">
										...
										<a href="?page=lap_farmasi_importdata_dinas" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
										<input name="upload" type="button" value="Upload Data" class="btn btn-sm btn-danger btnsimpans">
										<a href="lap_farmasi_importdata_dinas_excel.php" class="btn btn-sm btn-success">Download Template</a>
									</td>
								</tr>
							</table>
						</form>
				...
				<div class = "row">
					<form role="form">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" name="namapuskesmas" class="form-control" value="<?php echo $namapuskesmas;?>">
							<input type="hidden" name="tahun" class="form-control" value="<?php echo $tahun;?>">
						</div>
						<div class="col-sm-2">
							<button type="submit" class="btn btn-sm btn-warning"><span class="fa fa-search"></span></button>
							<a href="?page=lap_farmasi_importdata_dinas&kodepuskesmas=<?php echo $kodepuskesmas;?>&namapuskesmas=<?php echo $namapuskesmas;?>&tahun=<?php echo $tahun;?>" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
						</div>
					</form>
				</div>	
			</div>
				...
				<table class="table-judul-laporan-min" style="width:11000px">
					...
					<tbody>
						...
						while($data = mysqli_fetch_assoc($query)){
							...
							// echo "SELECT * FROM `$tbstokopnam` WHERE `KodeBarang`='$kodebarang' AND `Tahun`='$tahun'";
						...
						?>
							<tr>
								...
								<?php
									// apbd
									$gudang_apbd_total = $dtstokopname['Sisastok_Gudang_Apbd_12'] * $harga_apbd;
									$depot_apbd_total = $dtstokopname['Sisastok_Depot_Apbd_12'] * $harga_apbd;
									$igd_apbd_total = $dtstokopname['Sisastok_Igd_Apbd_12'] * $harga_apbd;
									$ranap_apbd_total = $dtstokopname['Sisastok_Ranap_Apbd_12'] * $harga_apbd;
									$poned_apbd_total = $dtstokopname['Sisastok_Poned_Apbd_12'] * $harga_apbd;
									$pustu_apbd_total = $dtstokopname['Sisastok_Pustu_Apbd_12'] * $harga_apbd;
									$pusling_apbd_total = $dtstokopname['Sisastok_Pusling_Apbd_12'] * $harga_apbd;
									$poli_apbd_total = $dtstokopname['Sisastok_Poli_Apbd_12'] * $harga_apbd;
									$lainnya_apbd_total = $dtstokopname['Sisastok_Lainnya_Apbd_12'] * $harga_apbd;
									...
									// jkn
									$gudang_jkn_total = $dtstokopname['Sisastok_Gudang_Jkn_12'] * $harga_jkn;
									$depot_jkn_total = $dtstokopname['Sisastok_Depot_Jkn_12'] * $harga_jkn;
									$igd_jkn_total = $dtstokopname['Sisastok_Igd_Jkn_12'] * $harga_jkn;
									$ranap_jkn_total = $dtstokopname['Sisastok_Ranap_Jkn_12'] * $harga_jkn;
									$poned_jkn_total = $dtstokopname['Sisastok_Poned_Jkn_12'] * $harga_jkn;
									$pustu_jkn_total = $dtstokopname['Sisastok_Pustu_Jkn_12'] * $harga_jkn;
									$pusling_jkn_total = $dtstokopname['Sisastok_Pusling_Jkn_12'] * $harga_jkn;
									$poli_jkn_total = $dtstokopname['Sisastok_Poli_Jkn_12'] * $harga_jkn;
									$lainnya_jkn_total = $dtstokopname['Sisastok_Lainnya_Jkn_12'] * $harga_jkn;
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_importdata_dinas&kodepuskesmas=$kodepuskesmas&namapuskesmas=$namapuskesmas&tahun=$tahun&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
