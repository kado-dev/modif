<?php$dataprolanis
	$idpasienrj = $_GET['id'];
	$dataprolanis = mysqli_fetch_assoc(mysqli_query($koneksi,"select * from `tbpoliprolanis` where `NoPemeriksaan` = '$noregistrasi'"));
?>
<div class = "row">
	<div class="col-sm-12">
		<table class="table-judul">
			<tr>
				...
				<td class="col-sm-10"><textarea name="anamnesa" class="form-control anamnesa"><?php echo $dataprolanis['Anamnesa'];?></textarea></td>
			</tr>
		</table>
	</div>	
</div><br/>	
