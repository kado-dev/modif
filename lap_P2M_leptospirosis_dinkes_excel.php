<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_P2M_Tracing_Penyakit (".$bulan.'-'.$tahun.").xls");
				...
				<?php
					...
					?>
						<tr style="border:1px solid #000;">
							...
							<td><?php echo substr($noindex,14);?></td>
