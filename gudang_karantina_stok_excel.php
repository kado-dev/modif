<?php
	...
	header("Content-Disposition: attachment; filename=Laporan Stok Gudang Karantina (".$kota." - ".$hariini.").xls");
	if(isset($key)){
?>
<style>
.tr, th{
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN STOK GUDANG KARANTINA</b></h4>
	<br/>
</div><br/>
