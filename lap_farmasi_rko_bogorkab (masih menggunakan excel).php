							...
							<table width="100%" style="margin-bottom: 10px;">	
								<tr>
									...
									<td width="20%">
										...
										<a href="lap_farmasi_rko_bogorkab_excel.php?tahun=<?php echo $_GET['tahun'];?>&namaprogram=<?php echo $_GET['namaprogram'];?>" class="btn btn-sm btn-success">Download Template</a>
									</td>
								</tr>
							</table>
						</form>
				...
				<table class="table-judul-laporan-min" style="font-size:12px;">
					...
					<?php
						...
						while($data = mysqli_fetch_assoc($query)){
							...
							// tahap 1, stok awal
							$strsopkm = "SELECT * FROM `$tbstokopnam` WHERE `KodePuskesmas`='$kodepuskesmas' AND `Tahun`='$tahun1' AND `KodeBarang`='$kodebarang'";
