...
<div class="tableborderdiv">
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>MONITORING INDIKATOR SPM (HIPERTENSI)</b></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_P2M_ptm_spm_hipertensi"/>
						...
						<div class="col-xl-10">
							...
							<a href="?page=lap_P2M_ptm_spm_hipertensi" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>MONITORING PENCAPAIAN KINERJA UKM DENGAN INDIKATOR SPM (HIPERTENSI)</b></span><br>
	...
	<div class="row noprint">
		<div class="col-sm-12">
			<div class="alert alert-block alert-success fade in">
				...
				<p><b>Kategori Kode Penyakit :</b> I10<br>
...
<script type="text/javascript">
	$('.btncls').click(function(){
		...
		$.post( "lap_P2M_ptm_spm_hipertensi.php?jqry=yes", { tahun: tahun })
		  .done(function( data ) {
