...
<div class="modal fade" id="modaleditdata" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
            <form class="form-horizontal" action="get_nomorsurat_mata_edit.php" method="post" role="form">
                <div class="modal-header" style="margin-bottom: -20px; border: none;">
                    <h5>Nomor Surat</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="text" name="nomorsurat" class="form-control inputan" placeholder="Format Nomor Surat" value="<?php echo $data['NomorSuratMata'];?>">
