...
<div class="row">	
	...
	<a href="javascript:print()" class="btn btn-sm btn-primary pull-right" style="margin-right:5px">Print</a>
	<a href="adm_invoice_lihat_excel.php?kd=<?php echo $kodepuskesmas?>" class="btn btn-sm btn-info pull-right" style="margin-right:5px">Excel</a>
	</div>
</div>
...
<!--tabel report-->
	<div class="printheader">
		...
		<h4 style="margin:30px; font-size: 22px;">INVOICE</h4>
	</div>
