...
$str = "INSERT INTO `tbgfkgemacermat`(`NoFakturKegiatan`,`TanggalKegiatan`,`Penyelenggara`,`Tempat`,`Peserta`,`JumlahApoteker`,`JumlahNakesLain`,`JumlahKader`,`JumlahMasyarakat`,`HasilKegiatan`,`RencanaTindakLanjut`,`FotoKegiatan1`,`FotoKegiatan2`,`FotoKegiatan3`) 
VALUES ('$nofaktur','$tanggalkegiatan','$penyelenggara','$tempat','$peserta','$peserta_apoteker','$peserta_tenagakesehatan','$peserta_kader','$peserta_masyarakat','$hasilkegiatan','$rencana','$namaimg','$namaimg2','$namaimg3')";
// echo $str;
// die();	
