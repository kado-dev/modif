	...
	<div class="row noprint">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_farmasi_pio_tarakan"/>
						<div class="col-sm-2">
						...
						<div class="col-sm-8">
							...
							<a href="?page=lap_farmasi_pio_tarakan" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_farmasi_pio_tarakan_excel.php?kd=<?php echo $kodepuskesmas;?>&keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_pio_tarakan&keydate1=$keydate1&keydate2=$keydate2&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
