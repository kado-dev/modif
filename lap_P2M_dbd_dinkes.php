...
<div class="tableborderdiv">
	<div class="row noprint">
        <div class="col-sm-12 table-responsive">
			...
			<h3 class="judul"><b>DBD</b></h3>
			<div class="formbg">
                 <form role="form" id="formsx">
				    <div class = "row">
						<input type="hidden" name="page" value="lap_P2M_dbd_dinkes"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-6">
							...
							<a href="?page=lap_P2M_dbd_dinkes" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
							<a href="javascript:print()" class="btn btn-round btn-primary"><span class="fa fa-print noprint"></span></a>
							<a href="lap_P2M_dbd_dinkes_excel.php?bulan=<?php echo $_GET['bulan'];?>&bulan2=<?php echo $_GET['bulan2'];?>&tahun=<?php echo $_GET['tahun'];?>&kd=<?php echo $_GET['puskesmas'];?>" class="btn btn-round btn-success">Excel</a>
						</div>
				    </div>
                </form>
			</div>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN P2P (DBD)</b></span><br>
			...
			<div class="table-responsive">
				<table class="table-judul-laporan" width="100%">
					...
					<tbody>
                        ...
                        $kodedgs = " AND (`KodeDiagnosa` like '%A90%' OR `KodeDiagnosa` like '%A91%')";
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_dbd_dinkes&bulan=$bulan&bulan2=$bulan2&tahun=$tahun&puskesmas=$kodepuskesmas&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
