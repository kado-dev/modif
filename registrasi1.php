									...
									<div class="table-responsive">
										<table class="table-bordered table-judul" width="100%">
											...
											<tbody>
												...
												?>
													<tr>
														<td style="text-align: center;"><?php echo date('d-m-Y', strtotime($dtriwayat['TanggalRegistrasi'])).", ".$dtriwayat['JamRegistrasi'];?></td>
											...
											<tr>
												...
												<td>
													<div class="row">
														<?php
															$tahunini = date('y');
															$str_kunj = "SELECT NoRegistrasi FROM `$tbpasienrj` WHERE (`IdPasien`='$idpasien' OR `nokartu`='$nokartu')";
