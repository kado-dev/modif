...
<div class="printheader">
	...
	<span class="font12" style="margin:1px;"><?php $bulandepan = $bulan + 1;echo "Pelaporan Bulan : ".nama_bulan($bulan);?></span><br/>
	<span class="font12" style="margin:1px;"><?php  $bulandepan = $bulan + 1; echo "Permintaan Bulan : ".nama_bulan($bulandepan);?></span>
	<br/>
	<br/>
</div>
		...
		<table class="table table-condensed" border="1">
			<thead>
				<tr>
					...
					<th width="7%" rowspan="2">SATUAN</th>
					<th colspan="2">STOK AWAL</th>
					<th colspan="2">PENERIMAAN</th>
					<th colspan="2">PERSEDIAAN</th>
					<th colspan="2">PENGELUARAN</th>
					<th colspan="2">SISA AKHIR</th>
					<th width="3%" rowspan="2">PERMINTAAN</th>
					<th width="3%" rowspan="2">PEMBERIAN</th>
			...
			<tbody>
				...
				?>
					<tr style="solid:1px dashed #000;">
						...
						<!--Stok Awal-->
						<td><?php echo $stokawal_apbd;?></td>
						<td><?php echo $stokawal_jkn;?></td>
						<!--Penerimaan-->
						<td class="penerimaancls"><?php echo rupiah($penerimaan_apbd);?></td>
						<td class="penerimaancls"><?php echo rupiah($penerimaan_jkn);?></td>
						<!--Persediaan-->
						<td class="persediaancls"><?php echo rupiah($persediaan_apbd);?></td>
						<td class="persediaancls"><?php echo rupiah($persediaan_jkn);?></td>
						<!--Pemakaian-->
						<td class="pemakaiancls"><?php echo $pengeluaran_apbd;?></td>
						<td class="pemakaiancls"><?php echo $pengeluaran_jkn;?></td>
						<!--SisaStok-->
						<td class="sisacls"><?php echo rupiah($sisa_apbd);?></td>
						<td class="sisacls"><?php echo rupiah($sisa_jkn);?></td>
						<td style="text-align:right; background-color:#dbf7ff;" class="permintaancls"><?php echo $permintaans;?></td>
