<div class="tableborderdiv">	
	<div class="row">
		<div class="col-xs-12">
			<a href="index.php?page=gudang_besar_gemacermat" class="backform"><i class="fa fa-chevron-circle-left fa fa-2x"></i><span></span></a>
			<h3 class="judul"><b>EDIT KEGIATAN GEMA CERMAT</b></h3>
			<div class="formbg" style="padding: 50px 50px 50px 50px;">
				<div class = "row">
					<form action="?page=gudang_besar_gemacermat_edit_proses" method="post" enctype="multipart/form-data">	
						<div class="table-responsive">
							...
							<table class="table">
								...
								<tr>
									...
									<td>
										<textarea name="rencana" style="text-transform: uppercase;" class="form-control penerimabarang"><?php echo $datagc['RencanaTidakLanjut'];?></textarea>
									</td>
								</tr>
								<tr>
