	...
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_loket_poli_dinkes"/>
						<div class="col-xl-3">
							...
							while($data3 = mysqli_fetch_assoc($queryp)){
								if($_GET['kodepuskesmas'] == $data3['NamaPuskesmas']){
						...
						<div class="col-xl-5">
							...
							<a href="?page=lap_loket_poli_dinkes" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_loket_poli_dinkes_excel.php?kodepkm=<?php echo $_GET['kodepuskesmas'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&asalpasien=<?php echo $_GET['asalpasien'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
					...
					<tbody>
							...
							?>
								<tr style="border:1px solid #000;">
									...
									<?php
										...
										$tanggal = $thn."-".$bln."-".$d2;
										$strs = "SELECT COUNT(IdPasienrj) AS jumlah 
										FROM `$tbpasienrj`
						...
						<tr style="border:1px solid #000;">
							...
							<?php
								...
								$tanggal = $thn."-".$bln."-".$d3;
								$strs2 = "SELECT COUNT(IdPasienrj) as Jumlah FROM `$tbpasienrj` WHERE date(`TanggalRegistrasi`) = '$tanggal'";
								// echo $strs2;
