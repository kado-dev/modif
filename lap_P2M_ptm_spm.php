...
<div class="tableborderdiv">
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>MONITORING INDIKATOR SPM</b></h3>
			<div class="formbg">
				<form role="form">	
					<div class = "row">
						<input type="hidden" name="page" value="lap_P2M_ptm_spm"/>
						...
						<div class="col-xl-10">
							...
							<a href="?page=lap_P2M_ptm_spm" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>MONITORING PENCAPAIAN KINERJA UKM DENGAN INDIKATOR SPM</b></span><br>
				...
				<table class="table-judul-laporan-min" width="100%">
					<thead>
						<tr style="border:1px solid #000;">
							...
							<th colspan="12" width="70%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Setiap Warga Negara Indonesia Usia 15-59 Tahun Mendapatkan Skrining Kesehatan Sesuai Standar</th>
							<th colspan="2" width="12%" style="text-align:center;vertical-align:middle; border:1px solid #000; padding:3px;">Total</th>
						</tr>
						<tr style="border:1px solid #000;">
							<th style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Kelurahan</th>
					...
					<tbody style="font-size:10px;">
						...
						while($data = mysqli_fetch_assoc($query)){
							...
							if ($kelurahan == 'Luar Wilayah'){
								$bulan_01 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '01' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_02 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '02' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_03 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '03' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_04 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '04' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_05 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '05' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_06 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '06' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_07 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '07' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_08 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '08' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_09 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '09' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_10 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '10' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_11 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '11' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
								$bulan_12 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '12' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` <> '$kelurahan'"));
							}else{
								$bulan_01 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '01' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` = '$kelurahan'"));
								$bulan_02 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '02' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` = '$kelurahan'"));
								$bulan_03 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(a.`NoPemeriksaan`)AS Jml FROM `tbpolilansia` a JOIN `$tbkk` b ON a.NoIndex = b.NoIndex WHERE SUBSTRING(a.`NoPemeriksaan`,1,11) = '$kodepuskesmas' AND YEAR(a.TanggalPeriksa) = '$tahun' AND MONTH(a.TanggalPeriksa) = '03' AND (`GdpLab`<>'0' OR `GdsLab`<>'0') AND b.`Kelurahan` = '$kelurahan'"));
	...
	<div class="row noprint">
		<div class="col-sm-12">
			<div class="alert alert-block alert-success fade in">
				...
				<p><b>Keterangan :</b><br>
				Data diambil dari Pelayanan Lansia Pemeriksaan Lab (Gdp & Gds)<br>
				</p>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$('.btncls').click(function(){
		...
		$.post( "lap_P2M_ptm_spm.php?jqry=yes", { tahun: tahun })
		  .done(function( data ) {
