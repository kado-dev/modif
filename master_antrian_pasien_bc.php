...
if($_POST['btn'] == 'simpan'){
	...
	`WaktuPelayananBuka`='$waktupelayananbuka',`WaktuPelayananTutup`='$waktupelayanantutup',StatusSlide = '$statusslide', RunningText = '$runningtext',Prolanis='$prolanis',Imunisasi='$imunisasi',Vaksin='$vaksin', versi_antrian = '$versi', Waktu = '$waktu' WHERE KodePuskesmas = '$kodepuskesmas'");
	...
	mysqli_query($koneksi,"UPDATE `tbantrian_pelayanan` SET `Pelayanan`='$pel_i', KodePelayanan = 'I', `Jumlah`='$jml_pel_i' WHERE `KodePuskesmas`='$kodepuskesmas' AND `KodePelayanan`='I'");
	mysqli_query($koneksi,"UPDATE `tbantrian_pelayanan` SET `Pelayanan`='$pel_j', KodePelayanan = 'J', `Jumlah`='$jml_pel_j' WHERE `KodePuskesmas`='$kodepuskesmas' AND `KodePelayanan`='J'");
	mysqli_query($koneksi,"UPDATE `tbantrian_pelayanan` SET `Pelayanan`='$pel_k', KodePelayanan = 'K', `Jumlah`='$jml_pel_k' WHERE `KodePuskesmas`='$kodepuskesmas' AND `KodePelayanan`='K'");
	mysqli_query($koneksi,"UPDATE `tbantrian_pelayanan` SET `Pelayanan`='$pel_l', KodePelayanan = 'L', `Jumlah`='$jml_pel_l' WHERE `KodePuskesmas`='$kodepuskesmas' AND `KodePelayanan`='L'");
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="input-group">
										<span class="input-group-addon" style="background:#f5f5f5;border-color:#ddd;color:#444">I</span>
										<?php
										...
										?>
										<select name="pelayanan_i" class="form-control pel_i">
											<option value="">Pilih Layanan</option>
											<option value="ANAK" <?php if($dtpel['Pelayanan'] == 'ANAK'){echo "SELECTED";}?>>ANAK</option>
											<option value="GIGI" <?php if($dtpel['Pelayanan'] == 'GIGI'){echo "SELECTED";}?>>GIGI</option>
											<option value="IMUNISASI" <?php if($dtpel['Pelayanan'] == 'IMUNISASI'){echo "SELECTED";}?>>IMUNISASI</option>
								...
								<div class="col-sm-4">
									<div class="input-group">
										<input type="text" value="<?php echo $dtpel['Jumlah'];?>" name="jml_pel_i" class="form-control" placeholder="Jumlah Antrian" maxlength="3">
									</div>	
								</div>	
							</div>
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="input-group">
										<span class="input-group-addon" style="background:#f5f5f5;border-color:#ddd;color:#444">J</span>
										<?php
										...
										?>
										<select name="pelayanan_j" class="form-control pel_j">
											<option value="">Pilih Layanan</option>
											<option value="ANAK" <?php if($dtpel['Pelayanan'] == 'ANAK'){echo "SELECTED";}?>>ANAK</option>
											<option value="GIGI" <?php if($dtpel['Pelayanan'] == 'GIGI'){echo "SELECTED";}?>>GIGI</option>
											<option value="IMUNISASI" <?php if($dtpel['Pelayanan'] == 'IMUNISASI'){echo "SELECTED";}?>>IMUNISASI</option>
								...
								<div class="col-sm-4">
									<div class="input-group">
										<input type="text" value="<?php echo $dtpel['Jumlah'];?>" name="jml_pel_j" class="form-control" placeholder="Jumlah Antrian" maxlength="3">
									</div>	
								</div>	
							</div>
							<span class="label_j" style="color:red;"></span>
							<div class="row">
								<div class="col-sm-8">
									<div class="input-group">
										<span class="input-group-addon" style="background:#f5f5f5;border-color:#ddd;color:#444">K</span>
										<?php
										...
										?>
										<select name="pelayanan_k" class="form-control pel_k">
											<option value="">Pilih Layanan</option>
											<option value="ANAK" <?php if($dtpel['Pelayanan'] == 'ANAK'){echo "SELECTED";}?>>ANAK</option>
											<option value="GIGI" <?php if($dtpel['Pelayanan'] == 'GIGI'){echo "SELECTED";}?>>GIGI</option>
											<option value="IMUNISASI" <?php if($dtpel['Pelayanan'] == 'IMUNISASI'){echo "SELECTED";}?>>IMUNISASI</option>
								...
								<div class="col-sm-4">
									<div class="input-group">
										<input type="text" value="<?php echo $dtpel['Jumlah'];?>" name="jml_pel_k" class="form-control" placeholder="Jumlah Antrian" maxlength="3">
									</div>	
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="input-group">
										<span class="input-group-addon" style="background:#f5f5f5;border-color:#ddd;color:#444">L</span>
										<?php
										...
										?>
										<select name="pelayanan_l" class="form-control pel_l">
											<option value="">Pilih Layanan</option>
											<option value="ANAK" <?php if($dtpel['Pelayanan'] == 'ANAK'){echo "SELECTED";}?>>ANAK</option>
											<option value="GIGI" <?php if($dtpel['Pelayanan'] == 'GIGI'){echo "SELECTED";}?>>GIGI</option>
											<option value="IMUNISASI" <?php if($dtpel['Pelayanan'] == 'IMUNISASI'){echo "SELECTED";}?>>IMUNISASI</option>
								...
								<div class="col-sm-4">
									<div class="input-group">
										<input type="text" value="<?php echo $dtpel['Jumlah'];?>" name="jml_pel_l" class="form-control" placeholder="Jumlah Antrian" maxlength="3">
									</div>	
								</div>
							</div>
