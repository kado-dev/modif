...
<div class="tableborderdiv">
	<div class="row search-page" id="search-page-1">
		<div class="col-xs-12">
			<h3 class="judul">DATA TOKO OBAT</h3>
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="sarpras_tokoobat"/>
						<div class="col-sm-8">
						...
						<div class="col-sm-4">
							...
							<a href="?page=sarpras_tokoobat" class="btn btn-primary btn-white"><span class="glyphicon glyphicon-refresh"></span></a>
							<?php if (in_array("APOTEK", $otoritas) || in_array("ADMINISTRATOR", $otoritas) || in_array("PROGRAMMER", $otoritas)){?>
							<a href="?page=sarpras_tokoobat_tambah" class="btn btn-success btn-white">Tambah Data</a>
							<?php }?>
						</div>
					</form>
				</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td align="center">
									<a href="?page=sarpras_tokoobat_lihat&id=<?php echo $data['NoFaktur'];?>" class="btn btn-xs btn-info btn-white"> Lihat</a>
									<?php
										...
										if($cekdata == ''){
									?>
									<a href="?page=sarpras_tokoobat_delete&id=<?php echo $data['NoFaktur'];?>" class="btn btn-xs btn-danger btn-white"> Hapus</a>
									<?php
										}
									?>
								</td>							
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=sarpras_tokoobat&kategori=$kategori&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
