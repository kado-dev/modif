...
<head>
	...
	<style>
		...
		.bgnavbar{
			background: #47A447;border-radius: 0px;
		}
	...
	<script>
		...
		//suara dengan rekaman manual
			...
			foreach($loket_arr_terbilang as $ar){
				...
				if($ar == "Satu"){
					$array_suara[] = "'http://127.0.0.1:8887/keloket_satu.wav'";
				}elseif($ar == "Dua"){
					$array_suara[] = "'http://127.0.0.1:8887/keloket_dua.wav'";
				}elseif($ar == "Tiga"){
					$array_suara[] = "'http://127.0.0.1:8887/keloket_tiga.wav'";
				}elseif($ar == "Empat"){
					$array_suara[] = "'http://127.0.0.1:8887/keloket_empat.wav'";	
				}		
			}
		  ...
		  source2.onmessage = function(event) {
			...
			jQuery.each(dt, function(i, val) {
		  	...
		  	if(wkt != split[1]){	
				...
				playsuara('http://127.0.0.1:8887/sound.wav');
