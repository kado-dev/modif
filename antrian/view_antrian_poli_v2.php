...
<body>
	...
	<div class="kotakkanan">
		<div class="alert alert-danger" style="font-size:20px">Silahkan klik salah satu poli</div>
		<div class="row">
			<?php
			$hariini = date('Y-m-d');
			...
			while($dt = mysqli_fetch_assoc($antrianpelayanan)){
				...
				?>
					<div class="col-sm-4">
						<a class="alistpoli" href="view_antrian_poli_v2_detail.php?poli=<?php echo $dt['Pelayanan'];?>">
						<div class="listpoli">
