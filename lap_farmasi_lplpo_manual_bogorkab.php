...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-xs-12">
			...
			<?php if($_GET['tahun']){ ?>
			<form class="form-inline" method="post" enctype="multipart/form-data" action="lap_farmasi_lplpo_manual_bogorkab_import.php">
			...
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_farmasi_lplpo_manual_bogorkab"/>
						...
						<div class="col-sm-4">
							...
							<a href="?page=lap_farmasi_lplpo_manual_bogorkab" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<!--<a href="javascript:print()" class="btn btn-sm btn-primary"><span class="fa fa-print noprint"></span></a>-->
							<?php if ($_GET['tahun'] != ''){ ?>	 
								<a href="lap_farmasi_lplpo_manual_bogorkab_excel.php?bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&sumberanggaran=<?php echo $_GET['sumberanggaran'];?>" class="btn btn-sm btn-success">Download Template</a>
							<?php }	?>
						</div>
					</form>
				</div>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_lplpo_manual_bogorkab&bulan=$bulan&tahun=$tahun&sumberanggaran=$sumberanggaran&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
