...
<div class="row">
	<div class="col-sm-12">
		<div class="sidebars">
			<div class="heading_grafik">Grafik Kunjungan Pasien Harian</div>
				...
				data:[
					<?php
						...
						for($d = $mulai; $d <= $selesai; $d++){	
							...
							$query_kunjungan = mysqli_query($koneksi,"SELECT `NoRegistrasi` FROM `$tbpasienrj` WHERE `TanggalRegistrasi` = '$tanggal' AND YEAR(`TanggalRegistrasi`)='$tahun'");
