...
$anamnesa1 = mysqli_real_escape_string($koneksi, $_POST['anamnesa']);
$anamnesa = strtoupper($anamnesa1);
...
// foreach($kddiagnosabpjs as $kddgs){
	...
	if(mysqli_num_rows($getdiagnosa) > 0){
		...
		while ($dtdiagnosa = mysqli_fetch_assoc($getdiagnosa)){	
			...
			$pstsehat_condition['code']['coding'][$arrdgs]['system'] = 'http://terminology.kemkes.go.id/CodeSystem/clinical-term';
...
mysqli_query($koneksi, "DELETE FROM $tbvitalsign WHERE `IdPasienrj`='$idpasienrj'");		
...
if($pelayanan == 'POLI UMUM'){
	...
	`Keluhan`,`Anamnesa`,`Anjuran`,`PemeriksaanHasilLab`,`KeadaanUmum`,`StatusGizi`,`PemeriksaanPenunjang`,`Kesadaran`,`Kepala`,`Mata`,`Hidung`,`Telinga`,`Mulut`,`Leher`,`Dada`,`Punggung`,`CP`,`Perut`,`HL`,`Kelamin`,`ExAtas`,`ExBawah`,`Lokalis`,`Effloresensi`,`Terapi`,`Diagnosa`,`RiwayatPenyakitSekarang`,`RiwayatPenyakitDulu`,`RiwayatPenyakitKeluarga`,`FaktorResikoLainnya`,`RiwayatAlergiMakanan`,`RiwayatAlergiUdara`,`RiwayatAlergiObat`,`RencanaPengelolaan`,`Prognosis`,`InformasiEso`,`Edukasi`,`TerapiObat`,`TerapiNonObat`,`Bmhp`,`NoResep`,`StatusPulang`,`RujukInternal`,`RujukLanjut`,`NamaPegawaiSimpan`) 
	VALUES ('$idpasienrj','$tanggal_time','$nopemeriksaan','$noindex','$nocm','$namapasien',
	'$keluhan','$anamnesa','$anjuran','$pemeriksaanhasillab','$keadaanumum','$statusgizi','$pemeriksaanpenunjangobj','$kesadaran','$kepala','$mata','$hidung','$telinga','$mulut','$leher','$dada','$punggung','$cp','$perut','$hl','$kelamin','$exatas','$exbawah','$lokalis','$effloresensi','$jsontherapy','$jsondiagnosa',
	'$riwayatpenyakitsekarang','$riwayatpenyakitdulu','$riwayatpenyakitkeluarga','$faktorresikolainnya','$riwayatalergimakanan','$riwayatalergiudara','$riwayatalergiobat','$rencanapengelolaan','$prognosa','$informasieso','$edukasi','$terapiObat','$terapiNonObat','$bmhp','$nopemeriksaan','$statuspulang','$rujukinternal','$rujuklanjut','$tenagamedisbpjs')";
	// echo $str;
	// die();
	$query=mysqli_query($koneksi,$str);	
	...
	`Keluhan`,`Anamnesa`,`AlergiImunisasi`,`Anjuran`,`PemeriksaanHasilLab`,`Sistole`,`Diastole`,`SuhuTubuh`,`BeratBadan`,`TinggiBadan`,`DetakNadi`, 
	`RR`,`RiwayatImunisasi`,`ImunisasiSekarang`,`Kipi`,`KipiLainnya`,`TglImunSelanjutnya`,`Ads005`,`Ads05`,`Ads5`,`Terapi`,`Diagnosa`,
	`RiwayatPenyakitSekarang`,`RiwayatPenyakitDulu`,`RiwayatPenyakitKeluarga`,`FaktorResikoLainnya`,`RiwayatAlergiMakanan`,
	`RiwayatAlergiUdara`,`RiwayatAlergiObat`,`RencanaPengelolaan`,`Prognosis`,`InformasiEso`,`Edukasi`,`TerapiObat`,`TerapiNonObat`,`Bmhp`,
	...
	'$keluhan','$anamnesa','$alergi_imunisasi','$anjuran','$pemeriksaanhasillab','$sistole','$diastole','$suhutubuh','$beratbadan','$tinggibadan','$heartrate',
	'$resprate','$riwayat_imunisasi','$jenis_imunisasi','$kipi','$kipilainnya','$tgl_imun_selanjutnya','$ads_005','$ads_05','$ads_5','$jsontherapy','$jsondiagnosa',
	'$riwayatpenyakitsekarang','$riwayatpenyakitdulu','$riwayatpenyakitkeluarga','$faktorresikolainnya','$riwayatalergimakanan',
	'$riwayatalergiudara','$riwayatalergiobat','$rencanapengelolaan','$prognosa','$informasieso','$edukasi','$terapiObat','$terapiNonObat','$bmhp',
	...
	mysqli_query($koneksi, "DELETE FROM `tbpolikir` WHERE `NoPemeriksaan`='$nopemeriksaan' AND `NoCM`='$nocm'");	
	...
	'$riwayatalergimakanan','$riwayatalergiobat','$rencanapengelolaan','$prognosa','$informasieso','$edukasi','$rujukinternal','$rujuklanjut','$tenagamedisbpjs')";
	// echo $str;
	// die();
	$query=mysqli_query($koneksi,$str);
	...
	$str = "INSERT INTO `tbpoliskd`(`IdPasienrj`, `TanggalPeriksa`, `NoPemeriksaan`, `NoIndex`, `NoCM`,`NoSurat`,`NamaPasien`,
	...
	VALUES ('$idpasienrj','$tanggal_time','$nopemeriksaan','$noindex','$nocm','$nomorsurat_skd','$namapasien',
	...
	mysqli_query($koneksi, "DELETE FROM $tbdiagnosaaskep WHERE `NoRegistrasi`='$nopemeriksaan'");
...
// insert ke tabel obat server BPJS
	$stspelayanan = $_POST['stspelayanan']; // status pelayanan luar gedung
	if($query){	
		...
		// }else{
			if($statuspulang == 4){
				...
				echo "document.location.href='index.php?page=poli_periksa_print&idrj=$idpasienrj&noreg=$nopemeriksaan&pelayanan=$pelayanan&stspelayanan=$stspelayanan';";
		...
		if($stspelayanan == ""){
			...
			// untuk mendirect ke pelayanan luar gedng (jejaring)
			echo "document.location.href='index.php?page=poli_periksa&id=$idpasienrj&pelayanan=$pelayanan&stspelayanan=$stspelayanan&status=Antri&tptgl=$tanggal_registrasi';";
		}
			echo "</script>";
	} 
?>