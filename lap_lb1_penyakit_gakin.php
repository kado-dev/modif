...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-xs-12">
			<h3 class="judul"><b>LB1-PENYAKIT (GAKIN)</b></h3>
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_lb1_penyakit_gakin"/>
						<div class="col-sm-2">
						...
						<div class="col-sm-3">
							...
							<a href="?page=lap_lb1_penyakit_gakin" class="btn btn-sm btn-success"><span class="fa fa-refresh"></span></a>
							<a href="lap_lb1_penyakit_gakin_excel.php?opsiform=<?php echo $_GET['opsiform'];?>&keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" class="btn btn-sm btn-info">Excel</a>
						</div>
					</form>
				</div>
			</div>	
	...
	<div class="row printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN LB1 - PENYAKIT (GAKIN)</b></span><br>
				...
				<table class="table-judul-laporan-min">
					<thead>
						<tr>
							...
							<th colspan="24" style="text-align:center;width:3%;vertical-align:middle; border:1px solid #000; padding:3px;">Jumlah Kasus Baru Menurut Golongan Umur</th>
							<th rowspan="2"  colspan="3" style="text-align:center;width:3%;vertical-align:middle; border:1px solid #000; padding:3px;">Kasus Baru</th>
							<th rowspan="2"  colspan="3" style="text-align:center;width:3%;vertical-align:middle; border:1px solid #000; padding:3px;">Kasus Lama</th>
							<th rowspan="3" colspan="3" style="text-align:center;width:3%;vertical-align:middle; border:1px solid #000; padding:3px;">Total Kasus</th>
						</tr>
						<tr>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_lb1_penyakit_gakin&keydate1=$keydate1&keydate2=$keydate2&opsiform=$opsiform&bulan=$bulan&tahun=$tahun&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
