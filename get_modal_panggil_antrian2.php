<?php
	...
	if($sts == 'selesai'){
		...
		$dtantrian = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT `IdAntrian`,`NomorAntrianPoli`,`PoliPertama` FROM $tbantrian_pasien WHERE `IdAntrian`='$id'"));
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="dataview" style="margin-top:10px;height:350px;overflow-y:auto">
								<div class="row">
									<div class="col-sm-4"><b>ANTRI</b></div>
									<div class="col-sm-4"><b>PENDING</b></div>
									<div class="col-sm-4"><b>SELESAI</b></div>
								</div>
								<div class="row">
									<div class="col-sm-4 listantr">
										<?php
										$qryantri = mysqli_query($koneksi, "SELECT `IdAntrian`,`IdPasienOnline`,`NomorAntrian`,`NomorAntrianPoli`, `PoliPertama` FROM `$tbantrian_pasien` WHERE date(WaktuAntrian) = curdate() AND `StatusAntrian` = 'Antri' order by NomorAntrian");
									...
									<div class="col-sm-4 listantr">
										<?php
											$qrypending = mysqli_query($koneksi, "SELECT `IdAntrian`,`IdPasienOnline`,`NomorAntrian`,`NomorAntrianPoli`,`PoliPertama` FROM `$tbantrian_pasien` WHERE date(WaktuAntrian) = curdate() AND `KodePuskesmas` = '$kodepuskesmas' AND `StatusAntrian` = 'Pending' order by NomorAntrian");
									...
									<div class="col-sm-4 listantr">
										<?php
											$qryselesai = mysqli_query($koneksi, "SELECT `IdPasienOnline`,`NomorAntrian`,`PoliPertama`,`NomorAntrianPoli`,`StatusDaftar` FROM `$tbantrian_pasien` WHERE date(WaktuAntrian) = curdate() AND `StatusAntrian` = 'Selesai' order by PoliPertama, NomorAntrianPoli");
								...
								<table class="table table-condensed table-bordered">
										...
										<tbody>
											<tr>
												<td>
													<?php
													// $qryselesaijkn1 = mysqli_query($koneksi,"select `IdAntrian`,`NomorAntrian`, `PoliPertama`, `NomorAntrianPoli` from `$tbantrian_pasien` WHERE date(WaktuAntrian) = curdate() AND `KodePuskesmas` = '$kodepuskesmas' AND `StatusAntrian` = 'Selesai' AND `StatusBpjs` = 'proses' order by NomorAntrian");
												...
												<td>
													<?php
													// $qryselesaijkn2 = mysqli_query($koneksi,"select `NomorAntrian`, `PoliPertama`, `NomorAntrianPoli` from `$tbantrian_pasien` WHERE date(WaktuAntrian) = curdate() AND `KodePuskesmas` = '$kodepuskesmas' AND `StatusAntrian` = 'Selesai' AND `StatusBpjs` = 'selesai' order by NomorAntrian");
