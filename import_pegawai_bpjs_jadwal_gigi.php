<?php
	...
	$data_medis = get_data_dokter_antrean_fktp('002',$tglsekarang);
	...
	if($list != ''){
		...
		$str2 = "DELETE FROM tbpegawaibpjsjadwal Where `kdpuskesmas` = '$kodepuskesmas' AND `kodepoli`='002'";
		...
		foreach($list as $ls){
			...
			$str = "INSERT INTO `tbpegawaibpjsjadwal`(`kdpuskesmas`,`kodepoli`,`namadokter`,`kodedokter`,`jampraktek`,`kapasitas`) VALUES ('$kdpuskesmas','002','$namadokter','$kddokter','$jampraktek','$kapasitas')";
