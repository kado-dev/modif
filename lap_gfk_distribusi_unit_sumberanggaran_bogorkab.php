...
<div class="tableborderdiv">
				...
				<div class = "row">
					<form role="form">
						...
						<div class="col-md-3">
							...
							<a href="lap_gfk_distribusi_unit_sumberanggaran_bogorkab_excel.php?&penerima=<?php echo $_GET['penerima'];?>&namaprg=<?php echo $_GET['namaprg'];?>&tahun=<?php echo $_GET['tahun'];?>&bulan1=<?php echo $_GET['bulan1'];?>&bulan2=<?php echo $_GET['bulan2'];?>" class="btn btn-success btn-white"><span class="fa fa-file-excel"></span></a>
						</div>
					</form>	
				</div>
			</div>
	...
	?>
		...
		<div class="printheader">
			...
			<span class="font14" style="margin:15px 5px 5px 5px;"><b>LAPORAN DISTRIBUSI UNIT (PER-NAMA PROGRAM)</b></span><br>
			<br/>
		</div>
			...
			<table class="table-judul">
				<thead>
					<tr>
						...
						<th width="5%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Tgl.Pengeluaran</th>
						<th width="25%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Nama Barang</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Nama Program</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Harga Satuan</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Jumlah</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Sub Total</th>
					</tr>
				</thead>
				<tbody>
					<?php
				...
				$min = $_GET['h'] - 4;
					if($i <= $max && $i >= $min){
						if($_GET['h'] == $i){
							...
							echo "<li><a href='?page=lap_gfk_distribusi_unit_sumberanggaran_bogorkab&bulan1=$bulan1&bulan2=$bulan2&tahun=$tahun&namaprg=$namaprg&penerima=$penerima&h=$i'>$i</a></li>";
						}
					}
				}
			?>	
		...
		<div class="table-responsive printbody">
			<table class="table-judul">
				<thead>
					<tr>
						<th width="3%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">No1.</th>
						<th width="5%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Tgl.Pengeluaran</th>
						<th width="25%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Nama Barang</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Nama Program</th>
						<th width="10%" style="text-align:center;width:5%;vertical-align:middle; border:1px solid #000; padding:3px;">Harga Satuan</th>
