...
<div class="tableborderdiv">
	<div class="row search-page noprint" id="search-page-1">
		<div class="col-xs-12">
			<h3 class="judul">RESEP (PELAYANAN)</h3>
			<div class="formbg">	
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_farmasi_apotik_resep_pelayanan"/>
						<div class="col-sm-3">
						...
						<div class="col-sm-6">
							...
							<a href="?page=lap_farmasi_apotik_resep_pelayanan" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN RESEP (PELAYANAN)</b></span><br>
					...
					<tbody style="font-size: 12px;">
						...
						?>
							<tr>
								...
								<td align="left"><?php echo str_replace('POLI','', $data['Pelayanan']);?></td>
									<?php
										$jml2 = 0;	
										for($d2= $mulai;$d2 <= $selesai; $d2++){	
										$tanggal = $thn."-".$bln."-".$d2;
										$strs = "SELECT COUNT(NoResep) as jumlah FROM `$tbresep` WHERE date(TanggalResep) = '$tanggal' AND `Pelayanan` = '$pelayanan'";
