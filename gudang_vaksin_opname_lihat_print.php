...
<div class="page">
<body onload="window.print()" onafterprint="document.location = 'index.php?page=gudang_vaksin_opnam_lihat&id=<?php echo $id;?>&nf=<?php echo $nf;?>&bl=<?php echo $bulan;?>&th=<?php echo $tahun;?>&sa=<?php echo $sumberanggaran;?>'">
	<?php
	...
	<div class="printheader" >
		...
		<span class="font16" style="margin:50px;"><b>LAPORAN STOK OPNAME GUDANG VAKSIN</b></span><br/>
				...
				<tbody>
					...
					?>
						...
						<tr style="border:1px solid #000;">
							...
							<td style="text-align:right; border:1px solid #000; padding:3px; color:red;font-weight:bold"><?php echo rupiah($stoksistem);?></td>
