			...
			<table class="table table-condensed">
				<thead style="font-size:10px;">
					<tr style="border:1px solid #000;">
						...
						<th width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">PPK</th>
						<th width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">PENYEDIA</th>
						<th width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">TEKNISI</th>
						<th width="20%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">SPESIFIKASI HARDWARE</th>
						<th width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">PELATIHAN</th>
					</tr>
				</thead>
				<tbody style="font-size:10px;">
					<?php
					$str = "SELECT * FROM `tbadm_antrian` WHERE `IdAntrian`='$idantriian'";
					...
					?>
						<tr>
							...
							<td align="center" style="border:1px solid #000; padding:3px;"><?php echo $data['PPK'];?></td>
							<td align="center" style="border:1px solid #000; padding:3px;"><?php echo $data['PenyediaHardware'];?></td>
