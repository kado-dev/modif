...
<div class="tableborderdiv">
	...
	<div class="table-responsive">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<a href="lap_gfk_kartustok_vaksin_lihat_excel.php?nf=<?php echo $nopembukuan;?>&kd=<?php echo $kodebarang;?>&batch=<?php echo $nobatch;?>&key=<?php echo $key;?>&orderby=<?php echo $_GET['orderby'];?>&sort=<?php echo $_GET['sort'];?>&bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>" class="btnsimpan" style="background: #5abdd6;">EXCEL</a>
			</div>
		</div>
	</div>
</div>
