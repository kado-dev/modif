<?php
	$idpasienrj = $_GET['id'];
	$datagigi = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `$tbpoligigi` WHERE `NoPemeriksaan` = '$noregistrasi'"));	
?>
	...
	<div class="col-sm-12">
		<table class="table-judul" width="100%">
			<tr>
				...
				<td class="col-sm-9"><textarea name="anamnesa" class="anamnesa form-control"><?php echo $datagigi['Anamnesa'];?></textarea></td>
			</tr>
		</table>
	</div>	
</div><br/>	
