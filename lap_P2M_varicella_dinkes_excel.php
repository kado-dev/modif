<?php
	...
	header("Content-Disposition: attachment; filename=Laporan P2P (VARICELLA/CACAR) (".$tahun.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN P2P (VARISELLA/CACAR)</b></h4>
	<p style="margin:1px;">
		<?php if($bulan == 'Semua'){ ?>
