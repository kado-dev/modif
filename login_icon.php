    ...
    <div class="container">
       <div class="row">	
            ...
            <div class="col-md-4 col-md-offset-4">
				<div class="logologin">
					<h3>e-Puskesmas Sabilulungan</h3>
					<p>Sistem Informasi Manajemen Puskesmas Online</p>
				</div>	
				<div class="login-panel panel panel-default">
					<div class="login-panel-login">LOGIN</div>
		...
		<img src="image/iconlg.png" class="iconlogin hidden-xs"/>
    </div>
	<div align="center" class="textbawah">
		<!--Copyright 2017 - "www.puskesmasonline.com" | <a href="puskesmas_registrasi.php">Demo Program</a><br/>-->
		Copyright 2017 www.puskesmasonline.com</a><br/>
		Office : Paskal Hyper Square Blok B.27 Bandung<br/>
