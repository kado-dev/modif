<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Register_Screening (".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTER PELAYANAN SCREENING</b></h4>
	...
	<div class="table-responsive noprint">
		<table class="table table-condensed" border="1">
			...
			<tbody>
				...
				$str = "SELECT a.TanggalPeriksa, b.NamaPasien, a.Anamnesa, a.NoPemeriksaan, a.NoCM, a.NoIndex, a.Sistole, a.Diastole, a.BeratBadan, a.TinggiBadan, a.SuhuTubuh, a.DetakNadi, a.RR, b.UmurTahun, b.JenisKelamin, b.StatusPulang, b.Asuransi, b.StatusKunjungan, c.NamaPegawai1, c.NamaPegawai2
				FROM `tbpoliscreening` a join `$tbpasienrj` b on a.NoPemeriksaan = b.NoRegistrasi join $tbpasienperpegawai c on a.NoPemeriksaan = c.NoRegistrasi
				WHERE ".$waktu;
