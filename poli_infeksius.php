<?php
	$idpasienrj = $_GET['id'];
	$asuransi = $_GET['cb'];
	$datapemeriksaan = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `tbpoliinfeksius` WHERE `NoPemeriksaan` = '$noregistrasi'"));
		...
		<table class="table-judul" width="100%">
			...
			<tr>
				...
				<td>
					...
					?>
					<input type="text" name ="pemeriksaanpenunjanglab" class="form-control" value="<?php echo $datapemeriksaan['PemeriksaanHasilLab']."".$pem_lab;?>">
				</td>
			</tr>
			<tr>
