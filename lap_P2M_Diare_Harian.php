...
<div class="tableborderdiv">
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>REGISTER DIARE</b></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_P2M_Diare_Harian"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-3">
							...
							<a href="?page=lap_P2M_Diare_Harian" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_P2M_Diare_Harian_Excel.php?keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&kasus=<?php echo $_GET['kasus'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
			...
			<div class="table-responsive">
				<table class="table-judul-laporan" width="100%">
					...
					<tbody>
						...
						$str2 = $str_diare."GROUP BY `NoRegistrasi` ORDER BY `TanggalDiagnosa` LIMIT $mulai,$jumlah_perpage";
						// echo $str2;
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_Diare_Harian&keydate1=$keydate1&keydate2=$keydate2&kasus=$kasus&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
	...
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			<div class="formbg">
				...
				- Klasifikasi Diare Kode ICD X (A03.0, A06.0, A09, A00.9, K58.0, K58.9)</p>
			</div>
		</div>
	</div>
</div>