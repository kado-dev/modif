...
<html lang="en">
    ...
    <body>
        <?php
            ...
            // tbsuratsehat
            $dtsuratmata = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `$tbsuratmata` WHERE `IdPasienrj` = '$idpasienrj'"));
       ...
       ?>
            <div class="page">
                ...
                ?>
                <p style="font-size: 18px; font-weight: bold; text-align: center; text-decoration: underline;">SURAT KETERANGAN HASIL PEMERIKSAAN MATA</p>
                <p style="text-align: center; margin-bottom: 10px; margin-top: -10px;"><?php echo "Nomor : ".$dtsuratmata['NomorSurat'];?></p>
                <p>
                    Yang bertanda tangan dibawah ini, Dokter Puskesmas <?php echo $namapuskesmas;?> menerangkan bahwa :
                </p>
                <table width="100%">
                ...
                <p> Berdasarkan hasil pemeriksaan buta warna yang telah dilakukan, yang bersangkutan saat ini dinyatakan:</p>
                <p style="font-size: 14px; font-weight: bold; text-align: center; text-transform: uppercase;"><?php echo $dtsuratmata['StatusPemeriksaan'];?></p>
                <p>Surat keterangan ini dibuat untuk keperluan : <?php echo $dtsuratmata['Keperluan'];?><br/>
                Catatan : <?php echo $dtsuratmata['Catatan'];?><br/><br/>
                Demikian surat ini dibuat dengan sesungguhnya agar dapat dipergunakan seperlunya.</p>                
                <table width="100%" align="center" class="fontkonten">
                    <tr>
                        ...
                        <td width="50%" valign="top">
                            <table width="100%">
                                <tr><td align="center"><?php echo $kota.", ".date('d-m-Y', strtotime($dtsuratmata['TanggalPeriksa']));?></td></tr>
                                <tr><td align="center">Dokter Pemeriksa</td></tr>
                                <tr><td align="center"><br/><br/><br/><?php echo $dtsuratmata['NamaDokter'];?></td></tr>
                            </table>
                        </td>
                    </tr>
                </table>
