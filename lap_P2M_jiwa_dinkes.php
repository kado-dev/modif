...
<div class="tableborderdiv">
	<div class="row noprint">
        <div class="col-sm-12 table-responsive">
			...
			<h3 class="judul"><b>JIWA</b></h3>
			<div class="formbg">
                 <form role="form" id="formsx">
				    <div class = "row">
						<input type="hidden" name="page" value="lap_P2M_jiwa_dinkes"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-8">
							...
							<a href="?page=lap_P2M_jiwa_dinkes" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
							<a href="javascript:print()" class="btn btn-round btn-primary"><span class="fa fa-print noprint"></span></a>
							<a href="lap_P2M_jiwa_dinkes_excel.php?bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&kd=<?php echo $_GET['puskesmas'];?>" class="btn btn-round btn-success">Excel</a>
						</div>
				    </div>
                </form>
			</div>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_jiwa_dinkes&bulan=$bulan&tahun=$tahun&puskesmas=$kodepuskesmas&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
    ...
    <div class = "row noprint">
        <div class="col-sm-12 table-responsive">
            <div class="formbg">
                <p><b>Perhatikan :</b><br/>
                    - Skizofrenia (F20)<br/>
                    - Gangguan Depresi (F32)<br/>
                    - Gangguan perilaku (F91)<br/>
                    - Disfungsi seksual yang tidak disebabkan oleh zat atau kondisi fisiologis yang diketahui (F52)<br/>
                    - Gangguan mental nonpsikotik lainnya (F48)<br/>
                    - Gangguan kecemasan (F41)<br/>
                    - Psikosis yang tidak spesifik (F29)<br/>
                    - Somatoform (F45)
                </p>
            </div>
        </div>
