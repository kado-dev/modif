<?php
	$idpasienrj = $_GET['id'];
	$dataanak = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `tbpolianak` WHERE `NoPemeriksaan` = '$noregistrasi'"));	
?>
	...
	<div class="col-sm-12">
		<table class="table-judul" width="100%">
			<tr>
				...
				<td class="col-sm-9"><textarea name="anamnesa" class="anamnesa form-control"><?php echo $dataanak['Anamnesa'];?></textarea></td>
			</tr>
		</table>
	</div>	
</div><br/>	
