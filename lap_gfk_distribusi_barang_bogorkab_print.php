...
<body onload="window.print()" onafterprint="document.location = 'index.php?page=lap_gfk_distribusi_barang_bogorkab&bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahunakhir=<?php echo $_GET['tahunakhir'];?>&namaprogram=<?php echo $_GET['namaprogram'];?>&key=<?php echo $_GET['key'];?>'">
	<div class="printheader">
		...
		<span class="font16" style="margin:15px 5px 5px 5px;"><b>DISTRIBUSI ITEM BARANG</b></span><br>
