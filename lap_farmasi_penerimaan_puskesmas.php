	...
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_farmasi_penerimaan_puskesmas"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-4">
							...
							<a href="?page=lap_farmasi_penerimaan_puskesmas" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_farmasi_penerimaan_puskesmas_excel.php?namaprg=<?php echo $_GET['namaprg'];?>&bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahun=<?php echo $_GET['tahun'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</div>	
				</form>	
			</div>
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_penerimaan_puskesmas&bulanawal=$bulanawal&bulanakhir=$bulanakhir&tahun=$tahun&namaprg=$namaprg&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
