<?php
	...
	$data_medis = get_data_dokter_antrean_fktp('012',$tglsekarang);
	...
	if($list != ''){
		...
		$str2 = "DELETE FROM tbpegawaibpjsjadwal Where `kdpuskesmas` = '$kodepuskesmas' AND `kodepoli`='012'";
		...
		foreach($list as $ls){
			...
			$str = "INSERT INTO `tbpegawaibpjsjadwal`(`kdpuskesmas`,`kodepoli`,`namadokter`,`kodedokter`,`jampraktek`,`kapasitas`) VALUES ('$kdpuskesmas','012','$namadokter','$kddokter','$jampraktek','$kapasitas')";
