<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_LB1_Penyakit_(Kasus ".$kasus.") (".$namapuskesmas." ".$bulan." ".$tahun.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN LB1- PENYAKIT (KASUS <?php echo strtoupper($kasus);?>)</b></h4>
	<p style="margin:1px;">
		...
		<table class="table table-condensed" border="1">
			<thead>
				<tr>
					...
					<th colspan="24">Jumlah Kasus <?php echo $kasus;?> Menurut Golongan Umur</th>
					<th rowspan="2" colspan="3">Kasus <?php echo $kasus;?></th>
				</tr>
				<tr>
