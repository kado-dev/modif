				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td align="center">
								<button class="btn btn-xs btn-info btn-white btnmodallihat" data-idkonsul="<?php echo $data['IdKonsultasi'];?>">Lihat</button>
								<?php if($_SESSION['otoritas'] == 'PROGRAMMER'){ ?>
								<input type="hidden" name="idkon" class="form-control" value="<?php echo $data['IdKonsultasi'];?>">
								<button value="hapus" type="submit" name="btn" class="btn btn-xs btn-danger btn-white btnhapusdata">Hapus</button>
								<?php }?>	
							</td>			
						</tr>
						<!--</form>-->
