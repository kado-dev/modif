...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-xs-12">
			<h3 class="judul"><b>REGISTER IMUNISASI CATIN</b></h3>
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_imunisasi_catin"/>
						<div class="col-sm-2">
						...
						<div class="col-sm-3">
							...
							<a href="?page=lap_imunisasi_catin" class="btn btn-sm btn-success"><span class="fa fa-refresh"></span></a>
							<a href="lap_imunisasi_catin_print.php?opsiform=<?php echo $_GET['opsiform'];?>&keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" target="_blank" class="btn btn-sm btn-primary"><span class="fa fa-print noprint"></span></a>
						</div>
					</form>	
				</div>
			</div>
			...
			<table class="table-judul-laporan">
				<thead style="font-size:10px;">
					<tr style="border:1px solid #000;">
						...
						<th rowspan="2" width="12%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Nama Suami</th>
						<th rowspan="2" width="12%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Alamat</th>
						<th colspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Status Pembayaran</th>
						<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Hasil Skrinning</th>
						<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Tgl.Imunisasi yang diberikan</th>
						<th rowspan="2" width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Tgl.Imunisasi berikutnya</th>
						<th colspan="5" width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Hasil Pemeriksaan Lab</th>
						<th rowspan="2" width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">Ket</th>
					</tr>
					<tr style="border:1px solid #000;">
						<th style="text-align:center; border:1px solid #000; padding:3px;">Umum</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">BPJS</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">PP Test</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">HB</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">HIV</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">Sifilis</th>
						<th style="text-align:center; border:1px solid #000; padding:3px;">HBsAg</th>
					</tr>
				</thead>
				<tbody style="font-size:10px;">
					...
					?>
						<tr style="border:1px solid #000;">
							...
							<td style="text-align:center; border:1px solid #000; padding:3px;"><?php echo $data_kk['NamaKK'];?></td>
							...
							<td style="text-align:left; border:1px solid #000; padding:3px;"><?php echo $data['ImunisasiSekarang'];?></td>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_imunisasi_catin&opsiform=$opsiform&keydate1=$keydate1&keydate2=$keydate2&bulan=$bulan&tahun=$tahun&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
