			...
			<div class="row">
				<div class="col-md-6" style="padding-left:0px">
					<div class="sidebars">
						...
						<form class="form-signin" action="login_proses_replika.php" method="post" style="margin-top:10px" autocomplete="off">
							...
							<button class="btn btn-md btn-success btn-login btn-block" type="button">Login</button>
						</form>
					</div>
				</div>
