...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-xs-12">
			<h3 class="judul"><b>PASIEN BPJS JIWA</b></h3>
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_bpjs_jiwa"/>
						<div class="col-sm-2">
						...
						<div class="col-sm-5">
							...
							<a href="?page=lap_bpjs_jiwa" class="btn btn-sm btn-success"><span class="fa fa-refresh"></span></a>
							<a href="lap_bpjs_jiwa_excel.php?bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&sts_bpjs=<?php echo $_GET['sts_bpjs'];?>" class="btn btn-sm btn-info">Excel</a>
						</div>
					</form>	
				</div>
			</div>
		...
		<table class="table table-condensed table-judul-laporan">
			<thead style="font-size:10px;">
				<tr style="border:1px solid #000;">
					...
					<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">NO.RM</th>
					<th rowspan="2" width="12%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">NAMA PESERTA</th>
					...
					<th rowspan="2" width="5%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">KUNJUNGAN</th>
				</tr>
				<tr style="border:1px solid #000;">
			...
			<tbody>
				...
				$str2 = $str." GROUP BY noKartu, StatusPasien ORDER BY Tanggalregistrasi, NamaPasien limit $mulai,$jumlah_perpage";
				// echo $str2;				
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_bpjs_jiwa&bulan=$bulan&tahun=$tahun&sts_bpjs=$sts_bpjs&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
	...
	<div class="row noprint">
		<div class="alert alert-block alert-success fade in">
			<p><b>Keterangan :</b><br/> 
			Pasien berkunjung lebih dari 1 (satu) kali maka dihitung 1 kali Kunjungan.</p>	
		</div>
	</div>
</div>	
<?php
