<?php
	...
	header("Content-Disposition: attachment; filename=Laporan LB1 Pelayanan Gigi (".$namapuskesmas." - ".$bulan."/".$tahun.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN LB1- PELAYANAN GIGI</b></h4>
	<p style="margin:1px;">
