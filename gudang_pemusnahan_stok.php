...
<div class="tableborderdiv noprint">
	<div class="row">
		<div class="col-xs-12">
			<h3 class="judul"><b>GUDANG PEMUSNAHAN</b></h3>
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="gudang_pemusnahan_stok"/>
						<div class="col-sm-5">
						...
						<div class="col-sm-7">
							...
							<a href="?page=gudang_pemusnahan_stok" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<a href="javascript:print()" class="btn btn-sm btn-primary"><span class="fa fa-print"></span></a>
							<a href="gudang_pemusnahan_stok_excel.php?key=<?php echo $_GET['key'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</form>	
				</div>	
			</div>
						...
						<tbody font="8">
							...
							<tr style="background:<?php echo $warna;?>;">
								...
								<td align="left" class="nama">
									...
									<span class="badge badge-success" style='padding: 4px;'><?php echo "Prg. ".$dtgfkstok['NamaProgram'];?></span><br/>
									<?php 
										echo "Tgl.Pemusnahan : ".$data['TanggalKarantina']."<br/>".
										"SK Pemusnahan : ".$data['SkPemusnahan']."<br/>".
										"SK Penghapusan : ".$data['SkPenghapusan']."<br/>".
										"Tempat Pemusnahan : ".$data['TempatPemusnahan'];
									?>
								</td>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=gudang_pemusnahan_stok&kategori=$kategori&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
