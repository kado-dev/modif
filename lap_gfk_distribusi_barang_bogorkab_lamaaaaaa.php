				...
				<div class = "row">
					<form role="form">
						...
						<div class="col-sm-2">
							...
							<a href="lap_gfk_distribusi_barang_bogorkab_excel.php?bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahunakhir=<?php echo $_GET['tahunakhir'];?>&namaprogram=<?php echo $_GET['namaprogram'];?>&key=<?php echo $_GET['key'];?>" class="btn btn-success btn-white"><span class="fa fa-file-excel"></span></a>
						</div>
					</form>	
				</div>	
			</div>
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						// echo "<li><a href='?page=lap_gfk_distribusi_barang_bogorkab&bulanawal=$bulanawal&tahunawal=$tahunawal&bulanakhir=$bulanakhir&tahunakhir=$tahunakhir&namaprogram=$namaprogram&key=$key&h=$i'>$i</a></li>";
						echo "<li><a href='?page=lap_gfk_distribusi_barang_bogorkab&bulanawal=$bulanawal&bulanakhir=$bulanakhir&tahunakhir=$tahunakhir&namaprogram=$namaprogram&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
