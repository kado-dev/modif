...
`HasilKegiatan`='$hasilkegiatan',`RencanaTidakLanjut`='$rencana',`FotoKegiatan1`='$namaimg',`FotoKegiatan2`='$namaimg2',`FotoKegiatan3`='$namaimg3' WHERE `IdKegiatan`='$idkegiatan'";
// echo $str;
// die();	
