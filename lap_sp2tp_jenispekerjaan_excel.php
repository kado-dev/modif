<?php
	...
	header("Content-Disposition: attachment; filename=Laporan SP2TP Jenis Pekerjaan (".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN SP2TP - (JENIS PEKERJAAN)</b></h4>
