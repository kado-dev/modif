<?php
	$idpasienrj = $_GET['id'];
	$datakia = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `$tbpolikia` WHERE `NoPemeriksaan` = '$noregistrasi'"));	
?>
	...
	<div class="col-sm-12">
		<table class="table-judul" width="100%">
			<tr>
				...
				<td class="col-sm-9"><textarea name="anamnesa" class="anamnesa form-control"><?php echo $datakia['Anamnesa'];?></textarea></td>
			</tr>
		</table>
	</div>	
</div><br/>	
