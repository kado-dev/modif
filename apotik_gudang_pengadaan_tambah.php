<div class="tableborderdiv">
	...
	<div class="formbg">
		<div class="row">	
			<div class="col-lg-12">
				<form class="form-horizontal" action="?page=apotik_gudang_pengadaan_tambah_proses" method="post" role="form">	
					<div class="table-responsive">
						<table class="table-judul">
							...
							<tr>
								<td>Tahun</td>
								<td>
									<input type="text" name="tahunanggaran" class="form-control" placeholder="Misal : 2022" maxlength="5">				
								</td>
							</tr>
							<tr>
								<td>Supplier</td>
