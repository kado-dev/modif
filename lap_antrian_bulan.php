...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>ANTRIAN PASIEN (BULANAN)</b></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_antrian_bulan"/>
						...
						<div class="col-xl-10">
							...
							<a href="?page=lap_antrian_bulan" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN ANTRIAN PASIEN (BULANAN)</b></span><br>
			...
			<div class="table-responsive">
				<table class="table-judul-laporan-min" width="100%">
					...
					<tbody>
						...
						$tbantrian = "tbantrian_pasien_".$kodepuskesmas;
						$str_all = "SELECT MONTH(WaktuAntrian) as bln, DAY(WaktuAntrian) as tgl, COUNT(IdAntrian) as jumlah 
						FROM `$tbantrian` 
						WHERE YEAR(WaktuAntrian) = '$tahun'
						GROUP BY MONTH(WaktuAntrian), DAY(WaktuAntrian)";
						...
						if($query_all){
							while($row = mysqli_fetch_assoc($query_all)){
								...
								if(!isset($antrian_data[$bln])){
									$antrian_data[$bln] = [];
								}
								$antrian_data[$bln][$tgl] = $jml;
						...
						?>
							<tr style="border:1px solid #000;">
								...
								for($d = 1; $d <= 31; $d++){
									...
									$count = isset($antrian_data[$kodebulan][$d]) ? $antrian_data[$kodebulan][$d] : 0;
									$jml_bulan += $count;
								?>	
...
<script type="text/javascript">
	$('.btncls').click(function(){
		...
		$.post( "lap_antrian_bulan.php?jqry=yes", { tahun: tahun })
		  .done(function( data ) {
