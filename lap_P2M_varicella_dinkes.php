...
<div class="tableborderdiv">
	<div class="row noprint">
        <div class="col-sm-12 table-responsive">
			...
			<h3 class="judul"><b>VARICELLA/CACAR</b></h3>
			<div class="formbg">
                 <form role="form" id="formsx">
				    <div class = "row">
						<input type="hidden" name="page" value="lap_P2M_varicella_dinkes"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-8">
							...
							<a href="?page=lap_P2M_varicella_dinkes" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
							<a href="javascript:print()" class="btn btn-round btn-primary"><span class="fa fa-print noprint"></span></a>
							<a href="lap_P2M_varicella_dinkes_excel.php?bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&kd=<?php echo $_GET['puskesmas'];?>" class="btn btn-round btn-success">Excel</a>
						</div>
				    </div>
                </form>
			</div>
	...
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN P2P (MUMP/GONDONGAN)</b></span><br>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_varicella_dinkes&bulan=$bulan&tahun=$tahun&puskesmas=$kodepuskesmas&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
