...
<body onload="window.print()" onafterprint="document.location = 'index.php?page=lap_registrasi_gizi_kia_kukarkab'">
	<div class="printheader">
		...
		<span class="font11" style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTER PASIEN POLI GIZI (KIA)</b></span><br>
			...
			<table class="table table-condensed">
				<thead style="font-size:10px;">
					<tr style="border:1px dashed #000;">
						...
						<th rowspan="2" width="9%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Nama Ibu</th>
						<th rowspan="2" width="9%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Nama Suami</th>
						...
						<th rowspan="2" width="6%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">GPA</th>
						<th rowspan="2" width="4%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Usia Kehamilan</th>
						<th rowspan="2" width="4%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">Kunj. ke</th>
						...
						<th rowspan="2" width="4%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">LILA</th>
						<th rowspan="2" width="4%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">TD</th>
						<th rowspan="2" width="4%" style="text-align:center; vertical-align:middle; border:1px dashed #000; padding:3px;">HB</th>
				...
				<tbody style="font-size:10px;">
					...
					if ($opsiform == 'bulan'){
						$str = "SELECT *
						FROM `tbpolikia` WHERE SUBSTRING(NoPemeriksaan,1,11) = '$kodepuskesmas' AND MONTH(TanggalPeriksa) = '$bulan' AND
						YEAR(TanggalPeriksa) = '$tahun'";
					}else{
						$str = "SELECT * FROM `tbpolikia` WHERE SUBSTRING(NoPemeriksaan,1,11) = '$kodepuskesmas' AND TanggalPeriksa = '$keydate'";
					}
					...
					while($data = mysqli_fetch_assoc($query)){
						...
						if ($data['K1Hb'] != '' || $data['K4Hb'] != ''){
							$hb = "K1:".$data['K1Hb'].", K4:".$data['K4Hb'];
						}else{
							$hb = "0";
						}
					...
					?>
						<tr style="border:1px dashed #000;">
							...
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $gpa;?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['UsiaKehamilan'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['KunjunganKehamilan'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['BeratBadan'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['TinggiBadan'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['Lila'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $data['Sistole']."/".$data['Diastole'];?></td>
							<td style="text-align:center; border:1px dashed #000; padding:3px;"><?php echo $hb;?></td>
