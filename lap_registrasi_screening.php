...
<div class="tableborderdiv">
	<div class="row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>REGISTER SCREENING</b></h3>
			<div class="formbg">
				<form role="form">
					<div class="row">
						<input type="hidden" name="page" value="lap_registrasi_screening"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-8">
							...
							<a href="?page=lap_registrasi_screening" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_registrasi_screening_excel.php?kd=<?php echo urlencode($kodepuskesmas);?>&keydate1=<?php echo urlencode($keydate1);?>&keydate2=<?php echo urlencode($keydate2);?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
	...
	<div class="printheader" style="display:none;">
		...
		<span class="font14"><b>REGISTER PELAYANAN SCREENING</b></span><br>
			...
			<div class="table-responsive">
				<table class="table-judul-laporan" width="100%" style="font-size:9px;">
					...
					<tbody>
						...
						$str_main = "SELECT a.TanggalPeriksa, b.NamaPasien, a.Anamnesa, a.NoPemeriksaan, a.NoIndex, a.NoCM,
						...
						if(!empty($rows)){
							...
							// Batch query tbkk
							$q_kk = mysqli_query($koneksi, "SELECT NoIndex, NamaKK, Alamat, RT, RW, Kelurahan 
						...
						foreach($rows as $data):
							...
							$kelurahan = isset($kk['Kelurahan']) ? $kk['Kelurahan'] : '';
							$alamat_pasien = isset($kk['Alamat']) ? $kk['Alamat'].", RT.".$kk['RT'].", RW.".$kk['RW'].", ".$kelurahan : '';
	...
	<div class="noprint">
		<?php if($h > 1): ?>
			<a href="?page=lap_registrasi_screening&keydate1=<?php echo urlencode($keydate1);?>&keydate2=<?php echo urlencode($keydate2);?>&h=<?php echo ($h-1);?>" class="btn btn-info">&laquo; Prev</a>
		<?php else: ?>
		...
		<?php if($has_next): ?>
			<a href="?page=lap_registrasi_screening&keydate1=<?php echo urlencode($keydate1);?>&keydate2=<?php echo urlencode($keydate2);?>&h=<?php echo ($h+1);?>" class="btn btn-info">Next &raquo;</a>
		<?php else: ?>
