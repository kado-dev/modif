<div class="tableborderdiv">	
	<div class="row">
		<div class="col-xs-12">
			...
			<h3 class="judul"><b>TAMBAH BARANG </b><small>Gudang Besar</small></h3>
			<div class="formbg" style="padding: 50px 50px 50px 50px;">
				<div class = "row">
					...
					?>
					<form class="form-horizontal" action="index.php?page=gudang_besar_stok_tambah_proses" method="post" role="form">
						<div class="table-responsive" style="font-size:12px">
							<table class="table table-striped table-condensed">
								...
								<tr>
									...
									<td>
										<select name="golonganfungsi" class="form-control golonganfungsi" required>
											<option value="">--Pilih--</option>
											<?php
								...
								<tr>
									...
									<td>
										<select name="jenisbarang" class="form-control jenisbarang" required>
											...
											<option value="GENERIK BERMERK">GENERIK BERMEREK</option>
											<option value="GENERIK BERMERK">PATEN</option>
											<option value="VAKSIN">VAKSIN</option>
								...
								<tr>
									<td>Ruangan</td>
									<td>
										<select name="ruangan" class="form-control ruangan" required>
											<option value="">--Pilih--</option>
								...
								<tr>
									<td>Rak</td>
									<td>
										<select name="rak" class="form-control rak" required>
											<option value="">--Pilih--</option>
