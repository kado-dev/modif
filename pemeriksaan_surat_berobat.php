<?php
    ...
    if($_POST['btnsimpan'] == 'simpan'){
        ...
        $tanggalberobat = date('Y-m-d', strtotime($_POST['tanggalberobat']))." ".date('G:i:s');       
        ...
        // tbsuratberobat
        $str = "INSERT INTO `$tbsuratberobat`(`IdPasienrj`, `IdPasien`, `TanggalBerobat`, `Keterangan`, `NamaDokter`) 
        VALUES ('$idpasienrj','$idpasien','$tanggalberobat','$keterangan','$namadokter')";
        $query = mysqli_query($koneksi,$str);
        $idsurat = mysqli_insert_id($koneksi);      

        // update nomorsurat
        $nomorsurat = $idsurat."/".$dtpuskesmas['NomorSuratBerobat'];    
        mysqli_query($koneksi, "UPDATE $tbsuratberobat SET `NomorSurat`='$nomorsurat' WHERE `IdSuratBerobat`='$idsurat'");
...
<div class="tableborderdiv">
    <form action="pemeriksaan_surat_berobat.php" method="post">
        ...
        <div class = "row">
            <div class="col-sm-12">
                <div class="formbg mt-2">
                    ...
                    <p style="font-size: 18px; font-weight: bold;" class="judul">Surat Keterangan Berobat</p>
                    <div class="table-responsive">
                        <table class="table-konten" width="100%">
                            <tr>
                                ...
                                <td class="col-sm-10">
                                    <div class="btn-group btn-block">
                                        <input type="text" name="nomorsurat" class="form-control inputan" value="<?php echo $dtpuskesmas['NomorSuratBerobat'];?>" readonly>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" name="tanggalberobat" class="form-control inputan" value="<?php echo $hariini;?>" autofocus>
                                </td>
                            </tr>
                            <tr>
                                <td>Keterangan</td>
                ...
                <table class="table-judul">
                    <thead>
                        <tr>
                            ...
                            <th width="15%">Tanggal Berobat</th>
                    ...
                    <tbody>
                        ...
                        $str = "SELECT * FROM `$tbsuratberobat` WHERE `IdPasien` = '$idpasien'";
                        $str2 = $str." ORDER BY `IdSuratBerobat` DESC LIMIT $mulai,$jumlah_perpage";
                        // echo $str2;
                        ...
                        while($data = mysqli_fetch_assoc($query)){
                            ...
                            $idsurat = $data['IdSuratBerobat'];
                        ?>
                            <tr>
                                <td align="center"><?php echo $no;?></td>
                                <td align="left"><?php echo $data['NomorSurat'];?></td>
                                <td align="center"><?php echo $data['TanggalBerobat'];?></td>          
                                <td align="left"><?php echo $data['Keterangan'];?></td>                  
                                <td align="left"><?php echo $data['NamaDokter'];?></td>                  
                                <td align="center">
                                    <a onClick="return confirm('Data ingin dihapus...?')" href="pemeriksaan_surat_berobat_hapus.php?idrj=<?php echo $idpasienrj;?>&idsurat=<?php echo $idsurat;?>" class="btn btn-sm btn-round btn-danger"><i class="fas fa-trash-alt"></i></a>
                                    <a href="cetak_surat_berobat.php?idrj=<?php echo $idpasienrj;?>&idpsn=<?php echo $idpasien;?>" class="btn btn-sm btn-round btn-info" target="_blank"><i class="fas fa-print"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
                        ...
                        $min = $_GET['h'] - 4;
                            if($i <= $max && $i >= $min){
                                if($_GET['h'] == $i){
                                    ...
                                    echo "<li><a href='?page=pemeriksaan_surat_berobat&tgl=$tgl&nama=$key&asuransi=$_GET[asuransi]&h=$i'>$i</a></li>";
                                }
                            }
                        }
                    ?>	
...
$('.btnmodalnomorsurat').click(function(){
    ...
    // alert(idpasienrj);	
    $.post( "get_nomorsurat_berobat.php", { id: idpasienrj })
    .done(function( data ) {
