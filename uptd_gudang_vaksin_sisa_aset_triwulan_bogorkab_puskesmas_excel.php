<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Vaksin_Sisa_Aset_Triwulan (".$kota." ".$keydate1." sd ".$keydate2.").xls");	
?>
<style>
.tr, th{
	text-align:center;
			...
			<table class="table table-condensed" border="1">
				...
				<tbody>
					<?php
						...
						$str2 = $str." GROUP BY `KodeBarang` ORDER BY `NamaBarang` ASC";
						// echo $str2;	
