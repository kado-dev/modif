...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-xs-12">
			<a href="index.php?page=lap_gfk_kartustok_bandungkab&key=<?php echo $key;?>" class="backform"><i class="fa fa-chevron-circle-left fa fa-2x"></i></a>
					...
					<div class="search-area well well-sm">
						...
						<div class = "row">
							<div class="col-sm-12 table-responsive" style="font-size:12px">
								<table class="table table-judul-form">
									...
									<tbody>
										...
										while($dt_stokawal = mysqli_fetch_assoc($query_stokawal)){
											...
											$stokawals[] = $jml_stokawal;
											$ttl_stokawals = array_sum($stokawals);
										...
										<tr style="background: #ffce8e; font-weight: bold;">
											...
											<td align="right">
												<?php  
													...
													//$jml_stokawal
													$sisastok = $ttl_stokawals + $ttl_terima - $ttl_keluar;
								...
								<div class="row">
									<div class="col-sm-6">
										<a href="lap_gfk_kartustok_bandungkab_lihat_print.php?kd=<?php echo $kodebarang;?>&batch=<?php echo $nobatch;?>&key=<?php echo $key;?>" class="btnsimpan">Print</a>
									</div>
									<div class="col-sm-6">
										<a href="lap_gfk_kartustok_bandungkab_lihat_excel.php?kd=<?php echo $kodebarang;?>&batch=<?php echo $nobatch;?>&key=<?php echo $key;?>&bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>" class="btnsimpan" style="background: #5abdd6;">Excel</a>
									</div>
								</div>	
							</div>
						</div>
