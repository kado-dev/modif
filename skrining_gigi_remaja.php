...
<div class="page-inner mt--5">
    <div class="row">
        <div class="col-md-12">
            <form action="skrining_gigi_remaja.php" method="post">  
                ...
                <div class="card">
                    <div class="card-body">
                        <p style="font-size: 20px; font-weight: bold;" class="judul">Skrining Kesehatan Gigi & Mulut Anak Usia Sekolah & Remaja
