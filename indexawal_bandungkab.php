				...
				<div class="col-md-7" style="padding-right:0px">
					<div class="mainbars" >
						...
						<div class="mainbars_p">
							<p>
								<span class="fontbg">Simpus Online <span style="font-size: 18px; color: yellow;">Versi 2.0</span></span><br/>
				...
				<div class="col-md-5" style="padding-left:0px">
					<div class="sidebars">
						...
						<form class="form-signin" action="login_proses.php" method="post" style="margin-top:25px">
							...
							<p style="font-size:12px">2019 - Sistem Informasi Manajemen Puskesmas<br/>Dinas Kesehatan Kabupaten Bandung</p>
