...
<style>
	...
	.left-bg{
		background: linear-gradient(0deg, rgba(20, 112, 228, 0.8), rgba(8, 72, 154, 1));
		height:100vh;
	...
	.formlogin{
		...
		background: linear-gradient(0deg, rgba(9, 74, 156, 0.8), rgba(20, 111, 227, 1));
		margin:3vh 4vw;
		padding:40px 40px;
		border-radius:15px;
		color : red;
			...
			<div class="right-bg-div">
				<div class="formlogin">
					...
					<form action="login_proses.php" method="post">
						...
						<div class="row">							
							<div class="col-md-6">
								<div class="wrap-input100 validate-input" data-validate = "captcha belum diisi">
									<input class="input100" type="text" name="captcha">
									<span class="focus-input100"></span>
								</div>
							</div>
							<div class="col-md-6">
								<img src="captcha.php" style="height:60px; width:100%"/>
							</div>
						</div>
						...
						<div class="container-login100-form-btn m-t-17">
							<a href="antrian/index.php" class="btn btn-round btn-info btnsimpan"><i class="icon-people"></i> Antrian Online</a>
						</div>
					</form>
				</div>
				<?php
