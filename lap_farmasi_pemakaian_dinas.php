	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_farmasi_pemakaian_dinas"/>
						<div class="col-sm-2">
					...
					<div class = "row" style="margin-top:10px;">	
						...
						<div class="col-sm-2">
							...
							<a href="?page=lap_farmasi_pemakaian_dinas" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<!--<a href="lap_farmasi_pemakaian_dinas_excel.php?namaprg=<?php echo $_GET['namaprg'];?>&bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahun=<?php echo $_GET['tahun'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>-->
						</div>
					</div>		
				</form>
			</div>
						...
						?>
								<tr>
									...
									for($b = intval($bulanawal);$b <= intval($bulanakhir); $b++){
										...
										if($bln_pengeluaran_apbd[$b] != 0 || $bln_pengeluaran_jkn[$b] != 0){
											$totbulan++;
										}
									?>	
									<td align="right">
									...
									<td align="right"><?php echo rupiah($rata_rata);?></td>
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_pemakaian_dinas&namaprg=$namaprg&bulanawal=$bulanawal&bulanakhir=$bulanakhir&tahun=$tahun&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
