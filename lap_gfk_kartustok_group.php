...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_gfk_kartustok_group"/>
						<div class="col-sm-8">
							<div class="row">
								<div class="col-sm-12">
						...
						<div class="col-sm-4">
							...
							<a href="?page=lap_gfk_kartustok_group" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
	...
	<div class="table-responsive">
		<table class="table-judul-laporan">
			...
			$str2 = $str." GROUP BY TahunAnggaran, NamaBarang ORDER BY `NoFakturTerima` DESC limit $mulai,$jumlah_perpage";	
			// echo $str2;
			...
			while($dtobat=mysqli_fetch_assoc($query)){
				...
				// $str_pengeluaran = "SELECT SUM(Jumlah) AS Jumlah FROM `tbgfkpengeluarandetail` a JOIN tbgfkpengeluaran b ON a.NoFaktur = b.NoFaktur
				// WHERE YEAR(b.TanggalPengeluaran) = '$tahunanggaran' AND `KodeBarang`='$kodeobat'";
			...
			?>
				<tr>
					...
					<td style="text-align:center; vertical-align:middle; padding:5px;" class="noprint"><a href="?page=lap_gfk_kartustok_group_lihat&kd=<?php echo $dtobat['KodeBarang'];?>&batch=<?php echo $dtobat['NoBatch'];?>&key=<?php echo $dtobat['NamaBarang'];?>&nofakturterima=<?php echo $dtobat['NoFakturTerima'];?>" class="btn btn-sm btn-danger">Lihat</a></td>
				</tr>
			<?php
			}
			?>		
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_gfk_kartustok_group&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
