        ...
        <div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
                 <form role="form" id="formsx">
				    <div class = "row">
						<input type="hidden" name="page" value="lap_P2M_penyakit_kronis"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-8">
							...
							<a href="?page=lap_P2M_penyakit_kronis" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
							<a href="javascript:print()" class="btn btn-round btn-primary"><span class="fa fa-print noprint"></span></a>
							<a href="lap_P2M_penyakit_kronis_excel.php?bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&kd=<?php echo $_GET['puskesmas'];?>" class="btn btn-round btn-success">Excel</a>
						</div>
				    </div>
                </form>
			</div>
					...
					<tbody>
						...
						?>
							<tr style="border:1px solid #000;">
								...
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=hipertensi&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Hipertensi['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=jantung&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Jantung['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=tbcparu&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $TbcParu['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=tbcsaraf&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $TbcSaraf['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=diabet&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Diabet['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=ginjal&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Ginjal['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=mental&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Mental['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=thalasemi&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $Thalasemi['Jml'];?></a></td>
								<td style="text-align:right; border:1px solid #000; padding:3px;"><a href="?page=lap_P2M_penyakit_kronis_detail&sts=sistemsaraf&bln=<?php echo $bulan;?>&thn=<?php echo $tahun;?>&pkm=<?php echo $namapuskesmas;?>" style="color: black" target="_blank"><?php echo $SistemSaraf['Jml'];?></a></td>
							</tr>
						<?php
						}
						?>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_penyakit_kronis&bulan=$bulan&tahun=$tahun&puskesmas=$kodepuskesmas&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
