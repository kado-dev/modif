					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="image/pegawai/<?php echo $_SESSION['foto_petugas'];?>" alt="Jason's Photo" />
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li class="divider"></li>
								<li><a href="?page=update_profile"><i class="fa fa-user"></i> Update Profile</a></li>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state noprint" id="breadcrumbs"><!--style="display:none;"-->
						<ul class="breadcrumb">
							<li>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">pkmonline</span>
							Versi 1.3 &copy; 2017
						</span>
					</div>
				</div>
