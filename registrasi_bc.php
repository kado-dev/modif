	...
	<div class="page-inner py-4">
		<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				...
				<h5 class="text-white op-7">Cilahkan cari data pasien</h5>
			</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table class="table-konten" width="100%">
										...
										<tr>
											<td>Asal Pasien <span style="color:red">*</span></td>
											<td>
												<div class="row">
													<select name="asalpasien" class="form-control inputan asalpasien">
										...
										<tr class="tmp_posyandu" style="display:none" required>
											...
											<td class="">
												...
												<select name="posyandu" class="form-control inputan">
													<option value="">--Pilih--</option>
													<?php
													$query = mysqli_query($koneksi,"SELECT * FROM `tbposyandu` order by `IdPosyandu`");
											...
											<td>
												<div class="row">
													<select name="polipertama" class="form-control inputan polipertama" required>
														...
														?>
														<option value='Data Ibu Hamil' class="tmp_pelayanan_posyandu" style="display:none">Data Ibu Hamil</option>
														<option value='Data Balita' class="tmp_pelayanan_posyandu" style="display:none">Data Balita</option>
														<option value='Data KB' class="tmp_pelayanan_posyandu" style="display:none">Data KB</option>
													</select>
												</div>
											</td>
										</tr>
										...
										<tr>
											<td>Tarif Administrasi</td>
											<td>
												<div class="row">
													<input type="hidden" value="<?php echo $_SESSION['tarifadministrasi'];?>" class="form-control inputan biayaadministrasi" readonly>
													<input type="text" name="tarifadministrasi" class="form-control inputan tarifadministrasi"  value="0" readonly>
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<div class="row">
													<input type="text" name="noantrian" class="form-control inputan noantrian" value="<?php echo $_SESSION['nomorantrian'];?>" placeholder="Klik menu panggil, sesuaikan nomer antrian pasien" readonly>
												</div>
											</td>
										</tr>
											...
											<td width="80%">
												<div class="row">
													...
													<select name="klaster" class="form-control inputan klaster" required>
														<option value="klaster 2" <?php if(strtolower($_SESSION['ses_Klaster']) == 'klaster 2'){echo 'SELECTED';}?>>Klaster 2 (Ibu dan Anak)</option>
														<option value="klaster 3" <?php if(strtolower($_SESSION['ses_Klaster']) == 'klaster 3'){echo 'SELECTED';}?>>Klaster 3 (Usia Dewasa dan Lansia)</option>
														<option value="klaster 4" <?php if(strtolower($_SESSION['ses_Klaster']) == 'klaster 4'){echo 'SELECTED';}?>>Klaster 4 (Penagulangan Penyakit Menular)</option>
														<option value="klaster 5" <?php if(strtolower($_SESSION['ses_Klaster']) == 'klaster 5'){echo 'SELECTED';}?>>Klaster 5 (Lintas Klaster)</option>
													</select>
												</div>
											</td>
										</tr>
...
$(document).ready(function() {
	...
	function set_siklushidup(){
		var klaster = $(".klaster").val().toLowerCase();
		if(klaster == 'klaster 2'){
			...
			var umur = tgllahir.split(" ")[0];
			if(parseInt(umur) >= 59){
				$(".siklus_hidup").html('<option value="Lanjut Usia" >Lanjut Usia</option>');
			}else{
				$(".siklus_hidup").html('<option value="Usia Dewasa" >Usia Dewasa</option>');
			}	
	...
	// komen dulu
	var polipertama = $(".polipertama").val();
