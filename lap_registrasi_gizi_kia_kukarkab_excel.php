<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Register_Poli_Gizi(KIA) (".$hariini.").xls");
...
<div class="printheader">
	...
	<span class="font12" style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTER PASIEN POLI GIZI (KIA)</b></span><br>
		...
		<table class="table table-condensed" border="1">
			<thead style="font-size:10px;">
				<tr style="border:1px dashed #000;">
					...
					<th rowspan="2" width="9%">Nama Ibu</th>
					<th rowspan="2" width="9%">Nama Suami</th>
					<th rowspan="2" width="6%">Tgl.Lahir</th>
					<th rowspan="2" width="12%">Alamat</th>
					<th rowspan="2" width="6%">GPA</th>
					<th rowspan="2" width="4%">Usia Kehamilan</th>
					<th rowspan="2" width="4%">Kunj. ke</th>
					<th rowspan="2" width="4%">BB</th>
					<th rowspan="2" width="4%">TB</th>
					<th rowspan="2" width="4%">LILA</th>
					<th rowspan="2" width="4%">TD</th>
					<th rowspan="2" width="4%">HB</th>
