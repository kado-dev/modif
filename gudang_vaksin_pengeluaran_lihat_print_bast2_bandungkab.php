...
<div class="body">	
	<?php if($kota == "KABUPATEN BANDUNG"){ ?>
		<img src="image/bandungkab.png" class="logokab" style="width:70px; margin: 0px 0px -90px 50px;">
	<?php }elseif($kota == "KABUPATEN BOGOR"){ ?>
		<img src="image/bogorkab.png" class="logokab" style="width:70px; margin: 0px 0px -90px 50px;">
	<?php }elseif($kota == "KABUPATEN BEKASI"){ ?>		
		<img src="image/bekasikab.png" class="logokab" style="width:70px; margin: 0px 0px -90px 50px;">
	<?php }	?>
	
	
	<div class="printheader"><br/>
	...
	<div class="row">
		<div class="col-sm-12">
			<table class="table table-condensed">
				...
				<tbody style="font-size:15px;">
					...
					while($data = mysqli_fetch_assoc($query)){
						...
						// tbgfk_vaksin_stok
						$dt_gfkstok = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `tbgfk_vaksin_stok` WHERE `KodeBarang`='$kdbrg' AND `NoBatch`='$batch' AND (NamaBarang LIKE 'Vaksin%' OR JenisBarang = 'VAKSIN')"));
			...
			<table width="50%" style="font-size: 12px;">
				...
				<tr>
					<td width="40%">NOMOR KENDARAAN / NOPOL</td>
					<td width="5%">:</td>
					<td width="50%"></td>
				</tr>
				<tr>
