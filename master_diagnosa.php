<div class="tableborderdiv">
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			...
			<a href="import_diagnosa_bpjs.php" class="btn btn-round btn-success">Import Diagnosa</a>
			<a href="master_diagnosa_excel.php?" class="btn btn-round btn-info" style="margin-right:5px">Excel</a>
			<table class="table-judul" style="margin-top: 10px">
				<thead>
					<tr>
						<th width="5%">No.</th>
