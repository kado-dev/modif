...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>KARTU STOK </b><small>GUDANG VAKSIN PUSKESMAS</small></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_gfk_kartustok_vaksin_puskesmas"/>
						<div class="col-xl-8">
							<div class="row">
								<div class="col-sm-12">
						...
						<div class="col-xl-4">
							...
							<a href="?page=lap_gfk_kartustok_vaksin_puskesmas" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_gfk_kartustok_vaksin_puskesmas_excel.php?key=<?php echo $_GET['key'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</div>
				</form>
			</div>
		...
		<table class="table-judul">
			<thead>
				<tr>
					...
					<th width="6%" style="text-align:center; vertical-align:middle; padding:10px;">KODE</th>
					<th width="25%" style="text-align:center; vertical-align:middle; padding:10px;">NAMA BARANG</th>
					...
					<th width="8%" style="text-align:center; vertical-align:middle; padding:10px;">HARGA SATUAN</th>
			...
			$min = $_GET['h'] - 19;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_gfk_kartustok_vaksin_puskesmas&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
