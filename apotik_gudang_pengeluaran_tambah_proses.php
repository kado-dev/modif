<?php
	...
	$namapegawaisimpan1 = mysqli_real_escape_string($koneksi, $_POST['nama_petugas']);
	$namapegawaisimpan = strtoupper($namapegawaisimpan1);
	...
	if($query){	
		...
		echo "document.location.href='index.php?page=apotik_gudang_pengeluaran_tambah';";
		echo "</script>";
	} 
?>