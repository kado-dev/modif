...
<li>
	...
	<ul class="submenu">
		...
		<li>
			...
			?>
			<a href="?page=poli&pelayanan=<?php echo $menu['Pelayanan'];?>&status=Antri">
...
<li>
	...
	<ul class="submenu">
		<li>
			...
			?>
			<a href="?page=apotik_pelayanan_resep">Pelayanan Resep
			<?php if ($dt_resep != 0){?><span class="badge badge-danger"><?php echo $dt_resep;}?></span></a>
		</li>
		<li>
			<a href="?page=lap_farmasi_ketersediaan_puskesmas_garutkab">Ketersediaan</a>
		</li>
		<li>
		...
		<li>
			...
			<b class="arrow"></b>
			<ul class="submenu">
				<li><a href="?page=lap_gfk_kartustok_gudang_puskesmas_garutkab">Kartu Stok<span class="badge" style="background:red;"></span></a></li>
				<li>
					<?php $go_puskesmas = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT COUNT(KodeBarang)AS Jml FROM `tbgudangpkmstok` WHERE `Stok` > '0' AND `KodePuskesmas` = '$kodepuskesmas'"));?>
				...
				<li><a href="?page=apotik_gudang_penerimaan_mandiri">Penerimaan Dinas</a></li>
				<li><a href="?page=apotik_gudang_pengadaan">Pengadaan Barang</a><b class="arrow"></b></li>
				<li><a href="?page=apotik_gudang_pengeluaran">Pengeluaran Barang</a></li>
...
<li>
	...
	<ul class="submenu">
		...
		<li>
			...
			<b class="arrow"></b>
			<ul class="submenu">
				<li><a href="?page=lap_registrasi_askep" target="_blank">Asuhan Keperawatan</a></li>
		...
		<li>
			...
			<ul class="submenu">
				...
				<li>
					<a href="?page=lap_farmasi_ketersediaan">Ketersediaan</a>
					<b class="arrow"></b>
				</li>
				<li>
				...
				<li><a href="?page=lap_farmasi_lplpo_manual">LPLPO</a></li>
		...
		<li>
			...
			<ul class="submenu">
				...
				<li><a href="?page=lap_P2M_remaja" target="_blank">Kesehatan Remaja</a></li>
