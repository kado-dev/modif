<?php
	...
	$data_medis = get_data_dokter_antrean_fktp('003',$tglsekarang);
	...
	if($list != ''){
		...
		$str2 = "DELETE FROM tbpegawaibpjsjadwal Where `kdpuskesmas` = '$kodepuskesmas' AND `kodepoli`='003'";
		...
		foreach($list as $ls){
			...
			$str = "INSERT INTO `tbpegawaibpjsjadwal`(`kdpuskesmas`,`kodepoli`,`namadokter`,`kodedokter`,`jampraktek`,`kapasitas`) VALUES ('$kdpuskesmas','003','$namadokter','$kddokter','$jampraktek','$kapasitas')";
