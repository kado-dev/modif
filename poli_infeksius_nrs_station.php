<?php
	$idpasienrj = $_GET['id'];
	$datainfeksius = mysqli_fetch_assoc(mysqli_query($koneksi,"select * from `tbpoliinfeksius` where `NoPemeriksaan` = '$noregistrasi'"));
?>
<div class = "row">
	<div class="col-sm-12">
		<table class="table-judul">
			<tr>
				...
				<td class="col-sm-10"><textarea name="anamnesa" class="form-control anamnesa"><?php echo $datainfeksius['Anamnesa'];?></textarea></td>
			</tr>
		</table>
	</div>	
</div><br/>	
