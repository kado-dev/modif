<div class="tableborderdiv">
	<div class="row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>STOK OPNAME </b><small>Gudang Vaksin Puskesmas</small></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="uptd_gudang_vaksin_sisa_aset_triwulan_bogorkab_puskesmas"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-2">
							<input type="text" name="keydate2" class="form-control datepicker" value="<?php echo $_GET['keydate2'];?>" placeholder = "Tanggal Akhir">
						</div>					
						<div class="col-xl-4">
						...
						<div class="col-xl-4">
							...
							<a href="?page=uptd_gudang_vaksin_sisa_aset_triwulan_bogorkab_puskesmas" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="uptd_gudang_vaksin_sisa_aset_triwulan_bogorkab_puskesmas_excel.php?keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&key=<?php echo $_GET['key'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</div>
				</form>	
			</div>
			...
			<table class="table-judul-laporan">
				...
				<tbody>
					<?php
						...
						$str2 = $str." GROUP BY `KodeBarang` ORDER BY `NamaBarang` ASC LIMIT $mulai,$jumlah_perpage";
						// echo $str2;	
						...
						while($data = mysqli_fetch_assoc($query_obat)){
							...
							// tahap3, penerimaan
							// $bln_penerimaan['1'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_01 + PenerimaanJkn_01) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['2'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_02 + PenerimaanJkn_02) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['3'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_03 + PenerimaanJkn_03) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['4'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_04 + PenerimaanJkn_04) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['5'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_05 + PenerimaanJkn_05) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['6'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_06 + PenerimaanJkn_06) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['7'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_07 + PenerimaanJkn_07) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['8'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_08 + PenerimaanJkn_08) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['9'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_09 + PenerimaanJkn_09) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['10'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_10 + PenerimaanJkn_10) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['11'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_11 + PenerimaanJkn_11) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));
							// $bln_penerimaan['12'] = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT (PenerimaanApbd_12 + PenerimaanJkn_12) AS Jumlah FROM `tbstokopnam_puskesmas_bogorkab`
										// WHERE KodeBarang = '$kodebarang' AND `KodePuskesmas`='$kodepuskesmas'"));	
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=uptd_gudang_vaksin_sisa_aset_triwulan_bogorkab_puskesmas&keydate1=$keydate1&keydate2=$keydate2&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
