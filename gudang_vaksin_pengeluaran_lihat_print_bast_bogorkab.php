<?php
	...
	// tbgfkpengeluaran
	$dtpengeluaran = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `tbgfk_vaksin_pengeluaran` WHERE `NoFaktur`='$nf'"));
	
	// tb_user_profil_sbbk
	$dtsbbk = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM `tb_user_profil_sbbk`"));
...
<div class="body">
	<img src="image/bogorkab.png" class="logokab" style="width:60px; margin: -10px 0px -90px 20px;">
	<center>
	<div class="printheader" style="margin-top: -15px;">
		...
		<!--<span style="font-size: 14px; margin:5px;">Kabupaten Bogor, Jawa Barat</span><br/>
	...
	<br/>
		...
		VAKSIN DAN PERBEKALAN KESEHATAN<br/>
		<span style="font-size:14px; margin-top: -10px;">Nomor : <?php echo $dtpengeluaran['NoFaktur'];?></span>
		</p>
		...
		<p align="left" style="margin-top:-10px;">Serah terima berdasar Surat Bukti Barang Keluar (SBBK) dari Dinas Kesehatan Kabupaten Bogor (terlampir).</p>
