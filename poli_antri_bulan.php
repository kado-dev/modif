...
<div class="tableborderdiv">
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="poli_antri_bulan"/>
						...
						<div class="col-xl-6">
							...
							<a href="?page=poli_antri_bulan" class="btn btn-round btn-success"><span class="fa fa-refresh"></span></a>
	...
	<div class="table-responsive noprint">
		<table class="table-judul-laporan">
			...
			$str = "SELECT * FROM `$tbpasienrj` WHERE MONTH(TanggalRegistrasi)='$bulan' and YEAR(TanggalRegistrasi)='$tahun' and StatusPelayanan='Antri' AND `StatusPasien`='1'".$nama_str;
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=poli_antri_bulan&bulan=$bulan&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
