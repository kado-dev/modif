<?php
	...
	header("Content-Disposition: attachment; filename=Laporan Register Kesehatan Remaja (".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTER KESEHATAN REMAJA</b></h4>
	...
	<div class="table-responsive noprint">
		<table class="table table-condensed" border="1">
			...
			<tbody style="font-size: 12px;">
				...
				$str2 = $str." GROUP BY NoRegistrasi ORDER BY `TanggalRegistrasi` DESC";
				// echo $str2;
				// die();
