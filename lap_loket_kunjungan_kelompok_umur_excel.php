<?php
	...
	header("Content-Disposition: attachment; filename=Laporan Kunjungan Kelompok Umur (".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN KUNJUNGAN KELOMPOK UMUR</b></h4>
