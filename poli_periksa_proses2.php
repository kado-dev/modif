...
foreach($kdobatlokal as $kdbrg){
	...
	//  die();
		...
		echo  $id_medicrequest_satusehat."<br/>";
		// die();
...
if($pelayanan == 'POLI UMUM'){
	...
	if($statuspulang == 5){
		...
		echo "UPDATE `$tbpasienrj` SET `StatusPelayanan` = 'Sudah', `StatusPulang` = '$statuspulang', `IdConditionSatuSehat` = '$id_cond_satusehat', `IdObservationSatuSehat` = '$id_obs_satusehat', `IdProcedureSatuSehat` = '$id_pro_satusehat', `IdMedicationSatuSehat` = '$id_medic_satusehat' WHERE `IdPasienrj` = '$idpasienrj'";
		die();
		mysqli_query($koneksi, "UPDATE `$tbpasienrj` SET `StatusPelayanan` = 'Sudah', `StatusPulang` = '$statuspulang', `IdConditionSatuSehat` = '$id_cond_satusehat', `IdObservationSatuSehat` = '$id_obs_satusehat', `IdProcedureSatuSehat` = '$id_pro_satusehat', `IdMedicationSatuSehat` = '$id_medic_satusehat' WHERE `IdPasienrj` = '$idpasienrj'");	
