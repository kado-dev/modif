				...
				<?php					
					...
					?>
						<tr>
							...
							<td style="text-align:center; border:1px sollid #000; padding:3px; background-color:#dbf7ff;"><?php echo $dtrko['StokAwal'];?></td>
							<td style="text-align:center; border:1px sollid #000; padding:3px; background-color:#dbf7ff;"><?php echo $dtrko['PemakaianRata'];?></td>
							<td style="text-align:center; border:1px sollid #000; padding:3px;"><?php echo $jumlah_kebutuhan;?></td>
							<td style="text-align:center; border:1px sollid #000; padding:3px;"><?php echo $rencana_kebutuhan;?></td>
							<td style="text-align:center; border:1px sollid #000; padding:3px; background-color:#dbf7ff;"><?php echo $dtrko['RencanaPengadaan'];?></td>
							<td style="text-align:center; border:1px sollid #000; padding:3px; background-color:#dbf7ff;"><?php echo $dtrko['RealisasiPengadaan'];?></td>
