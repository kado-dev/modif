<?php
	$idpasienrj = $_GET['id'];
	$asuransi = $_GET['cb'];
	$datahiv = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT * FROM `tbpolihiv` WHERE `NoPemeriksaan` = '$noregistrasi'"));
?>
...
<div class = "row">
	<div class="col-sm-12">
		...
		<tr>
			...
			<tr>
				<td>Anjuran</td>
				<td><input type="text" name ="anjuran" class="form-control" value="<?php echo $datahiv['Anjuran'];?>"></td>
			</tr>
			<tr>
				<td>Hasil Lab.</td>
				<td>
					...
					?>
					<input type="text" name ="pemeriksaanpenunjanglab" class="form-control" value="<?php echo $datahiv['PemeriksaanHasilLab']."".$pem_lab;?>">
				</td>
			</tr>
			<tr>
				...
				<td>
					<?php
						$arrprkpenunjang = explode(",",$datahiv['PemeriksaanPenunjang']);
					?>
					<div class="row">
						<div class="col-md-4">
