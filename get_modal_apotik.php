	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form class="form-horizontal" action="apotik_update_status.php" method="post" role="form">
				<input type="hidden" name="status_user" value="farmasi">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<table class="table-judul">
								...
								<?php
								$query = mysqli_query($koneksi,"SELECT * FROM `tbresepdetail` join `tbgfkstok` on tbresepdetail.Kodebarang = tbgfkstok.Kodebarang  WHERE tbresepdetail.NoResep='$id' AND `Pelayanan`='$data_resep[Pelayanan]'");
								...
								<tr>
									...
									<td align="left"><?php echo $data['AnjuranResep'];?></td>
									<td align="center"><a href="index.php?page=etiket&id=<?php echo $data_resep['NoResep'];?>&kd=<?php echo $data['KodeBarang'];?>"><i class="ace-icon fa fa-print bigger-130"></i></a></td>
								</tr>
								<?php
								}
								?>
				...
				<div class="modal-footer">
					...
					<button type="submit" value="submit"class="btn btn-lg btn-success pull-right">Print</button>
				</div>	
			</form>
		</div>
	</div>
