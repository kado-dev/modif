<?php
	...
	header("Content-Disposition: attachment; filename=Laporan Kunjungan Pelayanan (Bulan) (".$hariini.").xls");
	if(isset($tahun)){
?>
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>KUNJUNGAN PELAYANAN (BULAN)</b></h4>
		...
		<table class="table-judul-laporan" width="100%" border="1">
			...
			<tbody>
				...
				<?php
					...
					$dtshiftsore_01 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '01' AND date('H:i:s', strtotime(TanggalRegistrasi)) between '14:31' AND '21:30')"));
					$dtshiftsore_02 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '02' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_03 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '03' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_04 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '04' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_05 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '05' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_06 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '06' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_07 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '07' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_08 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '08' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_09 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '09' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_10 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '10' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_11 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '11' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
					$dtshiftsore_12 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(IdPasienrj) AS Jumlah FROM `$tbpasienrj` WHERE YEAR(`TanggalRegistrasi`)='$tahun' AND MONTH(`TanggalRegistrasi`) = '12' AND (TanggalRegistrasi between '14:31' AND '21:30')"));
