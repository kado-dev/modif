<div class="tableborderdiv">
	...
	<div class="formbg">
		<div class="row">
			<form role="form">
				<input type="hidden" name="page" value="dashboard_lplpo_bogorkab"/>
				<div class="col-sm-2">
				...
				<div class="col-sm-8">
					...
					<a href="?page=dashboard_lplpo_bogorkab" class="btn btn-success btn-white"><span class="fa fa-refresh"></span></a>
								...
								?>
									<tr>
										...
										<td>
											<?php
												// data apoteker										
												$dtapoteker = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT `NamaPegawai` FROM `tbpegawai` WHERE `status` = 'APOTEKER' AND `KodePuskesmas`='$data_lplpo[KodePuskesmas]'"));
												echo $dtapoteker['NamaPegawai'];
											?>
										</td>
										<td align="center">
											<?php 
												$tblplpomanual_bogorkab = "tblplpomanual_bogorkab_".$data_lplpo['KodePuskesmas'];
												$strlplpo = "SELECT COUNT(*) AS JumlahItem FROM `$tblplpomanual_bogorkab` 
												...
												if($dtlplpo['JumlahItem'] > 10){
											?>		
												<a href="?page=lap_farmasi_lplpo_puskesmas_bogorkab&kodepuskesmas=<?php echo $data_lplpo['KodePuskesmas'];?>&bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>&sumberanggaran=APBD KAB KOTA" target="_blank" class="btn btn-sm btn-success">Sudah</a>
											<?php
												}else{
											?>
												<a href="?page=lap_farmasi_lplpo_puskesmas_bogorkab&kodepuskesmas=<?php echo $data_lplpo['KodePuskesmas'];?>&bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>&sumberanggaran=APBD KAB KOTA" target="_blank" class="btn btn-sm btn-danger">Belum</a>
											<?php		
												}	
											?>
										</td>
