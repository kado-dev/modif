...
<div class="tableborderdiv">
	<div class = "row">
		<div class="col-sm-12 table-responsive">
			<h3 class="judul"><b>REGISTER HARIAN TIFOID</b></h3>
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_P2M_Tifoid_Harian"/>
						<div class="col-xl-2">
						...
						<div class="col-xl-6">
							...
							<a href="?page=lap_P2M_Tifoid_Harian" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_P2M_Tifoid_Harian_excel.php?keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&kasus=<?php echo $_GET['kasus'];?>" class="btn btn-round btn-success"><span class="fa fa-file-excel"></span></a>
	...
	<div class="printheader">
		...
		<span class="font14" style="margin:15px 5px 5px 5px;"><b>LAPORAN REGISTER TIFOID</b></span><br>
			...
			<div class="table-responsive">
				<table class="table-judul-laporan" width="100%">
					...
					<tbody>
						...
						// tbdiagnosa_bulan
						$str = "SELECT * FROM `$tbdiagnosapasien` WHERE TanggalDiagnosa BETWEEN '$keydate1' AND '$keydate2' AND (`KodeDiagnosa`='A01' OR `KodeDiagnosa`='A01.0' OR `KodeDiagnosa`='A01.1')".$qkasus; 
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_P2M_Tifoid_Harian&keydate1=$keydate1&keydate2=$keydate2&kasus=$kasus&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
		...
		<div class="col-sm-12 table-responsive">
			<div class="formbg">
				<p>
					...
					- Tifoid (Klinis) = A01<br/>
					- Konfirmasi Lab = A01.0, A01.1<br/>
				</p>
			</div>
		</div>
	</div>
