	...
	<div class="row noprint">
		<div class="col-sm-12 table-responsive">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_farmasi_lplpo_puskesmas"/>
						<?php
						...
						<div class="col-sm-3">
							...
							<a href="?page=lap_farmasi_lplpo_puskesmas" class="btn btn-round btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_farmasi_lplpo_puskesmas_print.php?kodepuskesmas=<?php echo $_GET['kodepuskesmas'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>&sumberanggaran=<?php echo $_GET['sumberanggaran'];?>" class="btn btn-round btn-primary"><span class="fa fa-print noprint"></span></a>
						</div>
					</div>
				</form>
			</div>
			...
			$min = $_GET['h'] - 4;
				...
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_lplpo_puskesmas&bulan=$bulan&tahun=$tahun&kodepuskesmas=$kodepuskesmas&sumberanggaran=$sumberanggaran&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
