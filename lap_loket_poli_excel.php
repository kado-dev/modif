			...
			<tbody>
					...
					?>
						<tr style="border:1px solid #000;">
							...
							<?php
								...
								FROM `$tbpasienrj`
								WHERE date(`TanggalRegistrasi`) = '$tanggal' AND SUBSTRING(NoRegistrasi,1,11)='$kodepuskesmas' 
								AND `PoliPertama` = '$pelayanan'".$aslpsn;
								// echo $strs;
				...
				<tr style="border:1px solid #000;">
					...
					<?php
						...
						WHERE date(`TanggalRegistrasi`) = '$tanggal' AND SUBSTRING(NoRegistrasi,1,11)='$kodepuskesmas'".$aslpsn.$stspsn;
