<?php
	...
	// narik nofaktur manual
	$dtdistribusi = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT `NoFakturManual` FROM `tbgfkpengeluaran` WHERE `NoFaktur`='$nf'"));
?>
<html lang="en">
<head>
	<title>SBBK</title>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/laporan_print.css" />
	<link rel="stylesheet" type="text/css" href="assets/css/f_laporan.css?=4">
	<!--!font-->
...
<body onload="window.print()" onafterprint="document.location = 'index.php?page=gudang_besar_pengeluaran_lihat_manual&id=<?php echo $id;?>&nf=<?php echo $nf;?>'">
	...
	<div class="printheader" style="margin-top: -150px;">
		<span class="font22" style="margin:5px;"><b><?php echo "DINAS KESEHATAN ".$kota;?></b></span><br/>
		<span class="font30" style="margin:5px;"><b>UPTD FARMASI</b></span><br/>
		<span class="font16" style="margin:5px;"><?php echo $alamat;?></span><br/>
		<span class="font16" style="margin:5px;"><b>e-mail : laporangudangtambun@gmail.com Telp. </b><?php echo $telepon?></span>
		<hr style="margin:10px 5px 5px 5px; border:1px solid #000">
		<span class="font22" style="margin:50px;"><b>SURAT BUKTI BARANG KELUAR</b></span><br/>
		<span class="font16" style="margin:1px;">No.Faktur: <?php echo $dtdistribusi['NoFakturManual'];?></span><br/>
	</div>
	...
	<div style="float:left; width:65%; margin-bottom:10px; font-family: 'Roboto Condensed', Arial, sans-serif">
	...
	<div class="row">
		<div class="col-sm-12">
			<table class="table table-condensed" style="border-collapse: collapse;">
				<thead style="font-size: 16px; font-family: 'Roboto Condensed', Arial, sans-serif;">
					<tr style="border:1px solid #000;">
						<th rowspan="2" width="3%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">NO.</th>
						<th rowspan="2" width="15%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">NAMA BARANG</th>
						...
						<th rowspan="2" width="8%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">SUMBER</th>
					...
					<tr style="border:1px solid #000;">
						...
						<th width="10%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">HARGA SAT.</th>
						<th width="10%" style="text-align:center; vertical-align:middle; border:1px solid #000; padding:3px;">TOTAL HARGA</th>
					</tr>
				</thead>
				<tbody style="font-size: 16px; font-family: 'Roboto Condensed', Arial, sans-serif;">
					<?php
					$total = 0;
					$jumlah = 0;
					$no = 0;
					...
					while($data = mysqli_fetch_assoc($query)){
						...
						$total = $jumlah + $total;
						$total_item_brg = $data['Jumlah'] + $total_item_brg;
					...
					?>
						<tr style="border:1px solid #000;">
							...
							<td align="center" style="border:1px solid #000; padding:3px;"><?php echo $sumber;?></td>
							<td align="right" style="border:1px solid #000; padding:3px;"><?php echo rupiah($data['Jumlah']);?></td>
							<td align="center" style="border:1px solid #000; padding:3px;"><?php echo terbilang($data['Jumlah']);?></td>
					...
					<tr style="font-weight: bold;border:0px solid #000;">
						<td colspan="6" style="text-align:center; border:0px solid #000; padding:3px;background-color:#eee">TOTAL</td>
						<td style="text-align:center; border:0px solid #000; padding:3px;background-color:#eee"><?php echo $total_item_brg;?></td>
						<td colspan="3" style="text-align:right; border:0px solid #000; padding:3px;background-color:#f9f9f9"><?php echo "Rp. ".number_format($total,2,",",".")?></td>
					</tr>
				</tbody>
						...
						<td class="report-footer-cell">
							<div class="footer-info">
								<center>
									...
									?>
									<table width="100%">
										<tr style="font-size: 16px; font-family: 'Roboto Condensed', Arial, sans-serif;">
											<td style="text-align:center;">
												<p style="margin-top:15px;">Yang Menerima<br/>
												<span style="font-size: 16px;"><?php echo $pengeluaran['Penerima'];?></span>
												<br>
												<br>
												<br>
												<p style="align:center;">
												<?php
													if($pengeluaran['PetugasPenerima'] == "" || $pengeluaran['PetugasPenerima'] == "-"){
														echo "(____________________________)";
													}else{
														echo "<u><b>".$pengeluaran['PetugasPenerima']."</b></u><br/>";
														echo "<p style='text-align: left;'>Nip.".$dtpenerima['Nip']."</p>";
													}
												?>			
												</p>
											</td>	
