<?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Bpjs_Perkunjungan (".$hariini.").xls");
...
<div class="printheader">
	...
	<h4 style="margin:15px 5px 5px 5px;"><b>LAPORAN BPJS PER-KUNJUNGAN</b></h4>
			...
			<tbody>
				...
				?>
					<tr style="border:1px solid #000;">
						...
						<td><?php echo $data['UmurTahun']." Th";?></td>
