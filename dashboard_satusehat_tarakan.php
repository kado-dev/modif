					...
					<div class = "row">
						<div class="col-sm-12">
							...
							<select name="namapuskesmas" class="form-control" onchange="this.form.submit();">
								...
								<?php 
									$query_puskesmas = mysqli_query($koneksi, "SELECT * FROM `tbpuskesmasdetail` ORDER BY NamaPPK");
							...
							<div class="table-responsive">
								<table class="table-judul" width="100%">
									...
									<tbody>
										...
										$str = "SELECT `KodePuskesmas`,`NamaPPK` FROM `tbpuskesmasdetail` ORDER BY NamaPPK";
	...
	<div class="row noprint" style="margin-top: -20px;">
		<div class="col-sm-12">
			<div class="kotak_panels bg">
				<div class="au-card m-b-30">
					<div class="au-card-inner">
						<canvas id="Grafik_Kujungan_Tahun" height="2000px"></canvas>
					</div>
				</div>
			</div>
		</div>
...
var Grafik_Kujungan_Tahun = new Chart(ctx, {
	...
	data: {
		labels: [
				<?php
					$strpuskesmas = "SELECT * FROM `tbpuskesmas` WHERE (NamaPuskesmas != 'DINAS KESEHATAN' AND NamaPuskesmas != 'UPTD FARMASI') ORDER BY `NamaPuskesmas`";
		...
		datasets: [
			{
				...
				while($datapuskesmas = mysqli_fetch_assoc($querypuskesmas)){					
					// tbpasienrj
					$namapuskesmas = $datapuskesmas['NamaPuskesmas'];
					$tbpasienrj = 'tbpasienrj_'.str_replace(' ', '', $namapuskesmas);
