	...
	<div class="row noprint">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<form role="form">
					<div class = "row">
						<input type="hidden" name="page" value="lap_farmasi_ketersediaan_dinas"/>
						<div class="col-sm-2">
					...
					<div class = "row" style="margin-top:10px;">
						...
						<div class="col-sm-2">
							...
							<a href="?page=lap_farmasi_ketersediaan_dinas" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<!--<a href="lap_farmasi_ketersediaan_dinas_excel.php?bulanawal=<?php echo $_GET['bulanawal'];?>&bulanakhir=<?php echo $_GET['bulanakhir'];?>&tahun=<?php echo $_GET['tahun'];?>&namaprg=<?php echo $_GET['namaprg'];?>&key=<?php echo $_GET['key'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>-->
						</div>
					</div>
				</form>	
			</div>
				...
				<table class="table-judul-laporan-min">
					<thead>
						<tr>
							...
							<th width="10%" rowspan="2">STOK AWAL<br/>(DESEMBER 2020)</td>
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_ketersediaan_dinas&bulanawal=$bulanawal&bulanakhir=$bulanakhir&tahun=$tahun&namaprg=$namaprg&key=$key&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
