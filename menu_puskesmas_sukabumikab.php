<?php
	...
	$apotikstok_poskesdes = mysqli_num_rows(mysqli_query($koneksi,"SELECT KodeBarang FROM $tbapotikstok WHERE `StatusBarang`='POSKESDES' AND `Stok` > '0'"));
...
<li class="nav-item">
	<a data-toggle="collapse" href="#sidebar_satusehat">
		<img src="image/satusehat.png" class="navbar-brand" width="25px"/>
		...
		<ul class="nav nav-collapse">
			...
			<li>
				...
				<a href="?page=poli&pelayanan=<?php //echo $menu['Pelayanan'];?>">
					<span class="sub-item"><?php //echo str_replace('POLI', 'LAYANAN', $menu['Pelayanan']);?>
			...
			<li>
				...
				<div class="collapse" id="depotobat">
					<ul class="nav nav-collapse subnav">
						...
						<li><a href="?page=apotik_stok&status=POSKESDES"><span class="sub-item">Poskesdes</span><span class="badge" style="background:red;"><?php echo $apotikstok_poskesdes;?></span></a></li>
