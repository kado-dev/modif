	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="formbg">
				<div class = "row">
					<form role="form">
						<input type="hidden" name="page" value="lap_farmasi_stok_opname_triwulan_dinas"/>
						<div class="col-sm-2">
						...
						<div class="col-sm-2">
							...
							<a href="?page=lap_farmasi_stok_opname_triwulan_dinas" class="btn btn-sm btn-info"><span class="fa fa-refresh"></span></a>
							<a href="lap_farmasi_stok_opname_triwulan_dinas_excel.php?keydate1=<?php echo $_GET['keydate1'];?>&keydate2=<?php echo $_GET['keydate2'];?>&namaprg=<?php echo $_GET['namaprg'];?>&kodepuskesmas=<?php echo $_GET['kodepuskesmas'];?>&namapuskesmas=<?php echo $_GET['namapuskesmas'];?>" class="btn btn-sm btn-success"><span class="fa fa-file-excel"></span></a>
						</div>
					</form>	
				</div>
			</div>	
			...
			$min = $_GET['h'] - 4;
				if($i <= $max && $i >= $min){
					if($_GET['h'] == $i){
						...
						echo "<li><a href='?page=lap_farmasi_stok_opname_triwulan_dinas&keydate1=$keydate1&keydate2=$keydate2&namaprg=$_GET[namaprg]&namapuskesmas=$namapuskesmas&kodepuskesmas=$kodepuskesmas&h=$i'>$i</a></li>";
					}
				}
			}
		?>	
